...
describe("ace-zig-linter UI contract tests", function () {
    this.timeout(40000);
    ...
    it("formats zig code and returns format edits", async function () {
        await harness.openScenario("ace-zig-linter");
