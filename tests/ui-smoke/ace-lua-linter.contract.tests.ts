...
describe("ace-lua-linter UI contract tests", function () {
    this.timeout(40000);
    ...
    it("formats lua code and returns format edits", async function () {
        await harness.openScenario("ace-lua-linter");
