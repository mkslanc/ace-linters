import { BaseConfig as CoreBaseConfig, ConfigObject, ConfigOverride as CoreConfigOverride, DeprecatedInfo, EcmaVersion as CoreEcmaVersion, EnvironmentConfig, GlobalAccess, GlobalsConfig, HasRules as CoreHasRules, JavaScriptParserOptionsConfig, JavaScriptSourceType, LanguageOptions as GenericLanguageOptions, LegacyConfigObject, LintMessage as CoreLintMessage, LintSuggestion as CoreLintSuggestion, LinterOptionsConfig, ObjectMetaProperties as CoreObjectMetaProperties, Plugin as CorePlugin, Processor as CoreProcessor, ProcessorFile as CoreProcessorFile, RuleConfig, RuleContext as CoreRuleContext, RuleDefinition, RuleFixer as CoreRuleFixer, RuleTextEdit, RuleTextEditor, RuleVisitor, RulesConfig, RulesMeta, Severity as CoreSeverity, SeverityLevel, SeverityName, SourceRange, SuggestedEdit, SuggestedEditBase, SuggestionMessage, TextSourceCode, TraversalStep, ViolationLocation, ViolationMessage, ViolationReport, ViolationReportBase } from '@eslint/core';
...
declare class SourceCode implements TextSourceCode<{
	...
	getTokenOrCommentBefore(node: ESTree.Node | AST.Token | ESTree.Comment, skip?: number | undefined): AST.Token | ESTree.Comment | null;
	/** @deprecated Use `getTokenAfter()` instead. */
	getTokenOrCommentAfter(node: ESTree.Node | AST.Token | ESTree.Comment, skip?: number | undefined): AST.Token | ESTree.Comment | null;
	...
	getTokens: ((node: ESTree.Node, beforeCount?: number, afterCount?: number) => AST.Token[]) & SourceCode.UnaryNodeCursorWithCountOptions;
	commentsExistBetween(left: ESTree.Node | AST.Token | ESTree.Comment, right: ESTree.Node | AST.Token | ESTree.Comment): boolean;
...
declare namespace SourceCode {
	...
	interface UnaryNodeCursorWithSkipOptions {
		<T extends AST.Token>(node: ESTree.Node, options: ((token: AST.Token) => token is T) | {
			filter: (token: AST.Token) => token is T;
			includeComments?: false | undefined;
			skip?: number | undefined;
		}): T | null;
		<T extends AST.Token | ESTree.Comment>(node: ESTree.Node, options: {
			filter: (tokenOrComment: AST.Token | ESTree.Comment) => tokenOrComment is T;
			includeComments: boolean;
			skip?: number | undefined;
		}): T | null;
		(node: ESTree.Node, options?: {
	...
	interface UnaryCursorWithSkipOptions {
		<T extends AST.Token>(node: ESTree.Node | AST.Token | ESTree.Comment, options: ((token: AST.Token) => token is T) | {
			filter: (token: AST.Token) => token is T;
			includeComments?: false | undefined;
			skip?: number | undefined;
		}): T | null;
		<T extends AST.Token | ESTree.Comment>(node: ESTree.Node | AST.Token | ESTree.Comment, options: {
			filter: (tokenOrComment: AST.Token | ESTree.Comment) => tokenOrComment is T;
			includeComments: boolean;
			skip?: number | undefined;
		}): T | null;
	...
	interface BinaryCursorWithSkipOptions {
		<T extends AST.Token>(left: ESTree.Node | AST.Token | ESTree.Comment, right: ESTree.Node | AST.Token | ESTree.Comment, options: ((token: AST.Token) => token is T) | {
			filter: (token: AST.Token) => token is T;
			includeComments?: false | undefined;
			skip?: number | undefined;
		}): T | null;
		<T extends AST.Token | ESTree.Comment>(left: ESTree.Node | AST.Token | ESTree.Comment, right: ESTree.Node | AST.Token | ESTree.Comment, options: {
			filter: (tokenOrComment: AST.Token | ESTree.Comment) => tokenOrComment is T;
			includeComments: boolean;
			skip?: number | undefined;
		}): T | null;
...
declare namespace Rule {
	...
	interface NodeListener extends RuleVisitor {
		...
		CallExpression?: ((node: ESTree.SimpleCallExpression & NodeParentExtension) => void) | undefined;
		"CallExpression:exit"?: ((node: ESTree.SimpleCallExpression & NodeParentExtension) => void) | undefined;
...
declare namespace Linter {
	 ...
	 */
	type BaseConfig<Rules extends RulesConfig = RulesConfig, OverrideRules extends RulesConfig = Rules> = CoreBaseConfig<Rules, OverrideRules>;
	/**
...
declare namespace ESLint {
	 ...
	 * @return The formatter output.
	 */
	type FormatterFunction = (results: LintResult[], context: LintResultData) => string | Promise<string>;
...
export declare class JavascriptService extends BaseService<JavascriptServiceOptions> implements LanguageService {
	...
	initConfig(): void;
	doValidation(document: lsp.TextDocumentIdentifier): Promise<lsp.Diagnostic[]>;
	setGlobalOptions(options: JavascriptServiceOptions): void;
}
