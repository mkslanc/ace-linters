"use strict";
(self["webpackChunkace_linters_root"] = self["webpackChunkace_linters_root"] || []).push([[144],{
...
class JsonService extends _base_service__WEBPACK_IMPORTED_MODULE_0__/* .BaseService */ .b {
    ...
    constructor(mode) {
        super(mode);
        this.$service = vscode_json_languageservice__WEBPACK_IMPORTED_MODULE_1__/* .getLanguageService */ .Oi({
