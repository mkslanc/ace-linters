...
manager.registerService("html", {
	...
	module: () => import("./html-service-YeKtz9Ct.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "HtmlService",
	modes: "html"
});
manager.registerService("css", {
	features: { signatureHelp: false },
	module: () => import("./css-service-BNFCEJgO.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("json", {
	...
	module: () => import("./json-service-LzdKtp1D.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("lua", {
	...
	module: () => import("./lua-service-Cal1sZfa.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("yaml", {
	...
	module: () => import("./yaml-service-CQiqOeCD.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("xml", {
	...
	module: () => import("./xml-service-jg7kGRav.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("php", {
	...
	module: () => import("./php-service-EClfHUSH.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "PhpService",
	modes: "php"
});
manager.registerServer("pythonls", {
	module: () => import("./language-client-CwSuMnOY.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	modes: "python",
	type: "socket",
...
manager.registerService("mysql", {
	module: () => import("./mysql-service-BWmGEwX3.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
