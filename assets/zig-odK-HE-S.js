...
var require_zig_highlight_rules = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop$1 = require_oop();
	var TextHighlightRules = require_text_highlight_rules().TextHighlightRules;
	var ZigHighlightRules$1 = function() {
		this.$rules = {
	...
	ZigHighlightRules$1.metaData = {
		fileTypes: ["zig"],
		keyEquivalent: "^~Z",
		name: "Zig",
		scopeName: "source.zig"
	};
	oop$1.inherits(ZigHighlightRules$1, TextHighlightRules);
	exports.ZigHighlightRules = ZigHighlightRules$1;
}));
var require_zig = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop = require_oop();
