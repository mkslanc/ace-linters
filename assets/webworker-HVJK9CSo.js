...
const dictAssetUrlsByPackage = {
	...
	"@cspell/dict-companies": new URL("" + new URL("cspell-dict-companies-gxW73xGc.json", import.meta.url).href, "" + import.meta.url).href,
	...
	"@cspell/dict-css": new URL("" + new URL("cspell-dict-css-uySMkyNs.json", import.meta.url).href, "" + import.meta.url).href,
	"@cspell/dict-dart": new URL("" + new URL("cspell-dict-dart-BIkrTka3.json", import.meta.url).href, "" + import.meta.url).href,
	"@cspell/dict-data-science": new URL("data:application/json;base64,", "" + import.meta.url).href,
	...
	"@cspell/dict-dotnet": new URL("" + new URL("cspell-dict-dotnet-DSTT0Sey.json", import.meta.url).href, "" + import.meta.url).href,
	...
	"@cspell/dict-en_us": new URL("" + new URL("cspell-dict-en_us-BdGkiP7p.json", import.meta.url).href, "" + import.meta.url).href,
	"@cspell/dict-en-gb-mit": new URL("" + new URL("cspell-dict-en-gb-mit-ke3i0qvQ.json", import.meta.url).href, "" + import.meta.url).href,
	"@cspell/dict-filetypes": new URL("data:application/json;base64,", "" + import.meta.url).href,
	...
	"@cspell/dict-fonts": new URL("" + new URL("cspell-dict-fonts-DuU_14VS.json", import.meta.url).href, "" + import.meta.url).href,
	...
	"@cspell/dict-fullstack": new URL("" + new URL("cspell-dict-fullstack-DsmLgfo8.json", import.meta.url).href, "" + import.meta.url).href,
	...
	"@cspell/dict-html": new URL("" + new URL("cspell-dict-html-Da43Ji-N.json", import.meta.url).href, "" + import.meta.url).href,
	...
	"@cspell/dict-k8s": new URL("" + new URL("cspell-dict-k8s-CtH6dVBO.json", import.meta.url).href, "" + import.meta.url).href,
	...
	"@cspell/dict-npm": new URL("" + new URL("cspell-dict-npm-DKzB9zEH.json", import.meta.url).href, "" + import.meta.url).href,
	...
	"@cspell/dict-public-licenses": new URL("" + new URL("cspell-dict-public-licenses-Dvl3yviI.json", import.meta.url).href, "" + import.meta.url).href,
	"@cspell/dict-python": new URL("" + new URL("cspell-dict-python-BhW_Egj5.json", import.meta.url).href, "" + import.meta.url).href,
	"@cspell/dict-r": new URL("" + new URL("cspell-dict-r-D1G0DDyQ.json", import.meta.url).href, "" + import.meta.url).href,
	"@cspell/dict-ruby": new URL("" + new URL("cspell-dict-ruby-DEWUQ1p9.json", import.meta.url).href, "" + import.meta.url).href,
	...
	"@cspell/dict-shell": new URL("" + new URL("cspell-dict-shell-B8KjqTz3.json", import.meta.url).href, "" + import.meta.url).href,
	"@cspell/dict-software-terms": new URL("" + new URL("cspell-dict-software-terms-DTUsNw2y.json", import.meta.url).href, "" + import.meta.url).href,
	...
	"@cspell/dict-terraform": new URL("data:application/json;base64,", "" + import.meta.url).href,
...
manager.registerService("html", {
	...
	module: () => import("./html-service-DKC2fzEd.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "HtmlService",
	modes: "html"
});
manager.registerService("css", {
	features: { signatureHelp: false },
	module: () => import("./css-service-CDReIlT9.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("json", {
	...
	module: () => import("./json-service-D9pJ1Oq9.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "JsonService",
	modes: "json"
});
manager.registerService("typescript", {
	module: () => import("./typescript-service-BCVGO_hh.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("lua", {
	...
	module: () => import("./lua-service-DZU5zxEp.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("yaml", {
	...
	module: () => import("./yaml-service-D1hJcMUJ.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("xml", {
	...
	module: () => import("./xml-service-CwKoJCP0.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("php", {
	...
	module: () => import("./php-service-PNWtuCdM.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("javascript", {
	...
	module: () => import("./javascript-service-D7qE7OyW.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("python", {
	...
	module: () => import("./python-service-BHqCdzZl.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "PythonService",
	modes: "python"
});
manager.registerService("mysql", {
	module: () => import("./mysql-service-BXbDdt7L.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "MySQLService",
	modes: "mysql"
});
manager.registerService("ace-spell-check", {
	module: () => import("./ace-spell-check-BT0XENPY.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
