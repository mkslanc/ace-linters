...
//#region node_modules/ace-code/src/mode/slim_highlight_rules.js
var require_slim_highlight_rules = /* @__PURE__ */ __commonJSMin(((exports) => {
			...
			"start": [
				{
					...
					onMatch: function(value, state, stack, line) {
						...
						var language = value.match(/^(\s*)(\w+):/)[2];
				...
				},
				{
					...
					onMatch: function(val, state, stack, line) {
						var indent = /^\s*/.exec(line)[0];
						if (stack.length < 1) stack.push(this.next);
						else stack[0] = "mlString";
						if (stack.length < 2) stack.push(indent.length);
						else stack[1] = indent.length;
						return this.token;
					},
					next: "mlString"
				},
...
//#endregion
export { require_slim_highlight_rules as t };
