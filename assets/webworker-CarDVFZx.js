...
manager.registerService("typescript", {
	...
	module: () => import("./typescript-service-DF8-AIZN.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("javascript", {
	...
	module: () => import("./javascript-service-CdvrkxOh.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
