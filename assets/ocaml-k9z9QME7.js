...
var require_ocaml_highlight_rules = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop$1 = require_oop();
	var TextHighlightRules = require_text_highlight_rules().TextHighlightRules;
	var OcamlHighlightRules$1 = function() {
	...
	oop$1.inherits(OcamlHighlightRules$1, TextHighlightRules);
	exports.OcamlHighlightRules = OcamlHighlightRules$1;
}));
var require_ocaml = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	(function() {
		this.toggleCommentLines = function(state, doc, startRow, endRow) {
			...
			var outdent = true;
			var re = /^\s*\(\*(.*)\*\)/;
			for (i = startRow; i <= endRow; i++) if (!re.test(doc.getLine(i))) {
				outdent = false;
				break;
			}
