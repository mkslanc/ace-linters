...
var require_assembly_x86_highlight_rules = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop$1 = require_oop();
	var TextHighlightRules = require_text_highlight_rules().TextHighlightRules;
	var AssemblyX86HighlightRules$1 = function() {
		this.$rules = { start: [
			{
	...
	AssemblyX86HighlightRules$1.metaData = {
		fileTypes: ["asm"],
		name: "Assembly x86",
		scopeName: "source.assembly"
	};
	oop$1.inherits(AssemblyX86HighlightRules$1, TextHighlightRules);
	exports.AssemblyX86HighlightRules = AssemblyX86HighlightRules$1;
}));
var require_assembly_x86 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop = require_oop();
