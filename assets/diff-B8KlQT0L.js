...
import { a as require_line_widgets, r as require_undomanager, t as require_edit_session } from "./edit_session-D9hX7Sjk.js";
import { n as require_decorators, t as require_virtual_renderer } from "./virtual_renderer-CBDw9D6y.js";
import { u as require_multi_select } from "./utils-B-ki7ewn.js";
//#region node_modules/ace-code/src/ext/diff/scroll_diff_decorator.js
...
//#endregion
//#region node_modules/ace-code/src/ext/diff/styles-css.js
...
//#endregion
//#region node_modules/ace-code/src/ext/diff/gutter_decorator.js
...
//#endregion
//#region node_modules/ace-code/src/ext/diff/base_diff_view.js
	...
	var DiffChunk = class DiffChunk {
		...
		*/
		constructor(originalRange, modifiedRange, charChanges) {
			...
			this.charChanges = charChanges && charChanges.map((m) => new DiffChunk(new Range(m.originalStartLineNumber, m.originalStartColumn, m.originalEndLineNumber, m.originalEndColumn), new Range(m.modifiedStartLineNumber, m.modifiedStartColumn, m.modifiedEndLineNumber, m.modifiedEndColumn)));
		}
	};
	var DiffHighlight = class {
		...
		*/
		...
		update(html, markerLayer, session, config) {
			...
			if (session.lineWidgets && !diffView.inlineDiffEditor) for (var row = config.firstRow; row <= config.lastRow; row++) {
			...
			lineChanges.forEach((lineChange) => {
				...
				if (lineChange.charChanges) for (var i = 0; i < lineChange.charChanges.length; i++) {
					...
					if (ignoreTrimWhitespace) for (let lineNumber = changeRange.start.row; lineNumber <= changeRange.end.row; lineNumber++) {
						...
						if (range.isEmpty() && startColumn !== 0) cssClass = "inline " + opOperation + " empty";
						markerLayer.drawSingleLineMarker(html, screenRange, "ace_diff " + cssClass, config);
					}
					else {
						let range = new Range(changeRange.start.row, changeRange.start.column, changeRange.end.row, changeRange.end.column);
						var screenRange = range.toScreenRange(session);
						let cssClass = "inline " + operation;
						if (range.isEmpty() && changeRange.start.column !== 0) cssClass = "inline empty " + opOperation;
						if (screenRange.isMultiLine()) markerLayer.drawTextMarker(html, screenRange, "ace_diff " + cssClass, config);
						else markerLayer.drawSingleLineMarker(html, screenRange, "ace_diff " + cssClass, config);
					}
				}
			});
		}
...
//#endregion
//#region node_modules/ace-code/src/ext/diff/inline_diff_view.js
...
//#endregion
//#region node_modules/ace-code/src/ext/diff/split_diff_view.js
...
//#endregion
//#region node_modules/ace-code/src/ext/diff/providers/default.js
var require_default = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var FastInt32Array = class {
		constructor() {
			this.positiveArr = /* @__PURE__ */ new Int32Array(10);
			this.negativeArr = /* @__PURE__ */ new Int32Array(10);
		}
		get(idx) {
			if (idx < 0) {
				idx = -idx - 1;
...
//#endregion
//#region node_modules/ace-code/src/ext/diff.js
