...
var require_ace_language_client = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(global, factory) {
		...
		*/
		...
		var import_showdown = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports$46, module$2) => {
			(function() {
				/**
				...
				*/
				...
				else if (typeof module$2 !== "undefined" && module$2.exports) module$2.exports = showdown;
...
`, "autocompletion.css", false);
		...
		var ServiceManager = class ServiceManager {
			...
			static async $initServiceInstance(service, ctx, workspaceUri) {
				...
				if ("type" in service) if (["socket", "webworker"].includes(service.type)) {
					module$3 = await service.module();
					service.serviceInstance = new module$3["LanguageClient"](service, ctx, workspaceUri);
				} else throw "Unknown service type";
				else {
					module$3 = await service.module();
					service.serviceInstance = new module$3[service.className](service.modes);
				}
		...
		var import_events = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports$47, module$4) => {
			...
			module$4.exports = EventEmitter;
			module$4.exports.once = once;
