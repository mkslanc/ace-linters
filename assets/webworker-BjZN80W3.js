...
manager.registerService("html", {
	...
	module: () => import("./html-service-ZG7d3jTA.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "HtmlService",
	modes: "html"
});
manager.registerService("css", {
	features: { signatureHelp: false },
	module: () => import("./css-service-yHKkKLRA.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("json", {
	...
	module: () => import("./json-service-BZEVq8Bq.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("lua", {
	...
	module: () => import("./lua-service-ibHwKwqt.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("yaml", {
	...
	module: () => import("./yaml-service-DUK0RtIq.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("xml", {
	...
	module: () => import("./xml-service-Bbig_xQa.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("php", {
	...
	module: () => import("./php-service-LNyr3qVZ.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "PhpService",
	modes: "php"
});
manager.registerServer("pythonls", {
	module: () => import("./language-client-DpmoHgYR.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	modes: "python",
	type: "socket",
...
manager.registerService("mysql", {
	module: () => import("./mysql-service-BPtidDei.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
