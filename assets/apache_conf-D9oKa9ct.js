...
var require_apache_conf_highlight_rules = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop$1 = require_oop();
	var TextHighlightRules = require_text_highlight_rules().TextHighlightRules;
	var ApacheConfHighlightRules$1 = function() {
		this.$rules = { start: [
			{
				token: [
	...
	ApacheConfHighlightRules$1.metaData = {
		fileTypes: [
			"conf",
			"CONF",
			"htaccess",
	...
	oop$1.inherits(ApacheConfHighlightRules$1, TextHighlightRules);
	exports.ApacheConfHighlightRules = ApacheConfHighlightRules$1;
}));
var require_apache_conf = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop = require_oop();
