...
var require_sparql_highlight_rules = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop$1 = require_oop();
	var TextHighlightRules = require_text_highlight_rules().TextHighlightRules;
	var SPARQLHighlightRules$1 = function() {
		this.$rules = {
			start: [
				{ include: "#comments" },
				{ include: "#strings" },
	...
	SPARQLHighlightRules$1.metaData = {
		fileTypes: ["rq", "sparql"],
		name: "SPARQL",
		scopeName: "source.sparql"
	};
	oop$1.inherits(SPARQLHighlightRules$1, TextHighlightRules);
	exports.SPARQLHighlightRules = SPARQLHighlightRules$1;
}));
var require_sparql = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop = require_oop();
