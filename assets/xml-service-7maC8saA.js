import { D as __commonJSMin, O as __esmMin, j as __toCommonJS, k as __export, r as require_main, t as BaseService } from "./base-service-BhPhkdcv.js";
import { n as checkValueAgainstRegexpArray } from "./webworker-eQmqoD2x.js";
...
function namespaceValidator(element) {
	...
	function checkPrefix(prefix, node) {
		...
		if (!declared[prefix]) issues.push({
	...
	if (element.ns) checkPrefix(element.ns, element);
	return issues;
}
var XmlService = class extends BaseService {
	...
	async doValidation(document) {
		...
		const customIssues = (0, import_api$4.validate)({
			doc: xmlDoc,
			validators: {
		...
		return [
			...
			...issuesToDiagnostic(customIssues, fullDocument, this.optionsToFilterDiagnostics)
		];
	}
};
export { XmlService };
