...
import { s as require_mouse_event, t as require_edit_session } from "./edit_session-DAgqly_m.js";
import { t as require_tooltip } from "./tooltip-BuOUCQpw.js";
...
//#region node_modules/ace-code/src/clipboard.js
...
//#endregion
//#region node_modules/ace-code/src/keyboard/textinput.js
	...
	var TextInput = class {
		...
		*/
		constructor(parentNode, host) {
			...
			if (!("oncut" in this.text) || !("oncopy" in this.text) || !("onpaste" in this.text)) event.addListener(parentNode, "keydown", (e) => {
		...
		*/
		...
		$resetSelection() {
			...
			var positionToSelection = (row, column) => {
				...
				for (var i = 1; i <= row - this.rowStart && i < 2 * this.numberOfExtraLines + 1; i++) selection += this.host.session.getLine(row - i).length + 1;
				return selection;
			};
...
//#endregion
//#region node_modules/ace-code/src/mouse/default_handlers.js
...
//#endregion
//#region node_modules/ace-code/src/mouse/default_gutter_handler.js
var require_default_gutter_handler = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	...
	var GutterTooltip = class GutterTooltip extends HoverTooltip {
		/**
...
//#endregion
//#region node_modules/ace-code/src/mouse/dragdrop_handler.js
...
//#endregion
//#region node_modules/ace-code/src/mouse/touch_handler.js
...
//#endregion
//#region node_modules/ace-code/src/mouse/mouse_handler.js
...
//#endregion
//#region node_modules/ace-code/src/mouse/fold_handler.js
...
//#endregion
//#region node_modules/ace-code/src/keyboard/keybinding.js
...
//#endregion
//#region node_modules/ace-code/src/search.js
...
//#endregion
//#region node_modules/ace-code/src/commands/command_manager.js
...
//#endregion
//#region node_modules/ace-code/src/commands/default_commands.js
	...
	exports.commands = [
		{
			...
			exec: function(editor) {
				config.loadModule("ace/ext/settings_menu", function(module$3) {
					module$3.init(editor);
		...
		},
		{
			...
			exec: function(editor) {
				config.loadModule("ace/ext/error_marker", function(module$4) {
					module$4.showErrorMarker(editor, 1);
				});
			},
		...
		},
		{
			...
			exec: function(editor) {
				config.loadModule("ace/ext/error_marker", function(module$5) {
					module$5.showErrorMarker(editor, -1);
				});
			},
			scrollIntoView: "animate",
			readOnly: true
...
//#endregion
//#region node_modules/ace-code/src/keyboard/gutter_handler.js
...
//#endregion
//#region node_modules/ace-code/src/editor.js
	...
	var Editor = class Editor {
		...
		**/
		prompt(message, options, callback) {
			var editor = this;
			config.loadModule("ace/ext/prompt", function(module$2) {
				module$2.prompt(editor, message, options, callback);
			});
		}
		get hoverTooltip() {
