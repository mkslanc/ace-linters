...
var require_vala_highlight_rules = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop$1 = require_oop();
	var TextHighlightRules = require_text_highlight_rules().TextHighlightRules;
	var ValaHighlightRules$1 = function() {
		this.$rules = {
			start: [{
				token: [
					"meta.using.vala",
	...
	oop$1.inherits(ValaHighlightRules$1, TextHighlightRules);
	exports.ValaHighlightRules = ValaHighlightRules$1;
}));
var require_vala = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop = require_oop();
