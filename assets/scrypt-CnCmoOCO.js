...
//#region node_modules/ace-code/src/mode/scrypt_highlight_rules.js
/****************************************************************************************
...
var require_scrypt_highlight_rules = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var scryptHighlightRules = function() {
		var keywordMapper = this.createKeywordMapper({
			...
			"keyword": "contract|library|loop|new|private|public|if|else|struct|type|require|static|const|import|exit|return|asm",
			"constant.language": "true|false",
			"support.function": "function|auto|constructor|bytes|int|bool|SigHashPreimage|PrivKey|PubKey|Sig|Ripemd160|Sha1|Sha256|SigHashType|SigHashPreimage|OpCodeType"
		}, "identifier");
		this.$rules = {
			"start": [
				{
...
//#endregion
//#region node_modules/ace-code/src/mode/scrypt.js
