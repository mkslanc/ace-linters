...
manager.registerService("html", {
	...
	module: () => import("./html-service-B3OcrkS2.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "HtmlService",
	modes: "html"
});
manager.registerService("css", {
	features: { signatureHelp: false },
	module: () => import("./css-service-Dj7flXfN.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("json", {
	...
	module: () => import("./json-service-Cbc20bv_.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "JsonService",
	modes: "json"
});
manager.registerService("typescript", {
	module: () => import("./typescript-service-BSwKaHyx.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("lua", {
	...
	module: () => import("./ace-lua-linter-DMChG7aD.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("yaml", {
	...
	module: () => import("./yaml-service-CWAsY00L.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("xml", {
	...
	module: () => import("./xml-service-YVd4PETu.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("php", {
	...
	module: () => import("./php-service-Cnw5uBMQ.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("javascript", {
	...
	module: () => import("./javascript-service-DPnFP3kt.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("python", {
	...
	module: () => import("./python-service-BAvYyYWj.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "PythonService",
	modes: "python"
});
manager.registerService("mysql", {
	module: () => import("./mysql-service-CHQohDi5.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "MySQLService",
	modes: "mysql"
});
manager.registerService("clang", {
	module: () => import("./ace-clang-linter-Dkh_RicV.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "AceClangLinter",
	modes: "c_cpp"
});
manager.registerService("zig", {
	module: () => import("./ace-zig-linter-D2XsQH-F.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "AceZigLinter",
	modes: "zig"
});
manager.registerService("dart", {
	module: () => import("./ace-dart-linter-CTzYYpYy.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "AceDartLinter",
	modes: "dart"
});
manager.registerService("golang", {
	module: () => import("./ace-go-linter-BmyaKLb4.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
