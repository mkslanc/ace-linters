...
import { r as require_undomanager } from "./edit_session-BlcJnX8K.js";
...
import { i as require_popup, t as require_autocomplete } from "./autocomplete-DNfsPPz_.js";
import { t as require_modelist } from "./modelist-B77hJ0ao.js";
import { t as require_overlay_page } from "./overlay_page-DLYSZTkg.js";
//#region node_modules/ace-code/src/ext/prompt.js
/**
		...
		prompt(editor, "", {
			...
			getCompletions: function(cmdLine) {
				function getFilteredCompletions(commands, prefix) {
					...
					return new FilteredList(resultCommands).filterCompletions(resultCommands, prefix);
				}
