//#region packages/demo/docs-example/html-example.js
var htmlContent = `
    <!DOCTYPE html>
<html>
    <head>
    ...
    `;
//#endregion
//#region packages/demo/docs-example/css-example.js
...
`;
//#endregion
//#region packages/demo/docs-example/less-example.js
...
`;
//#endregion
//#region packages/demo/docs-example/scss-example.js
...
`;
//#endregion
//#region packages/demo/docs-example/tsx-example.js
var tsxContent = `
...
`;
//#endregion
//#region packages/demo/docs-example/lua-example.js
var luaContent = `--[[--
...
`;
//#endregion
//#region packages/demo/docs-example/yaml-example.js
var yamlContent = `
---
...
`;
//#endregion
//#region packages/demo/docs-example/php-example.js
var phpContent = `
<?php
e
function nfact($n) {
...
?>
    `;
//#endregion
//#region packages/demo/docs-example/xml-example.js
var xmlContent = `
<people>
...
`;
//#endregion
//#region packages/demo/docs-example/python-example.js
var pythonContent = `
import os
...
# 34
    ...
    `;
//#endregion
//#region packages/demo/docs-example/mysql-example.js
