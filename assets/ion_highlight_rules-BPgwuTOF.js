	...
	var IonHighlightRules = function() {
		var keywordMapperRule = {
			token: this.createKeywordMapper({
				...
				"constant.language.null.ion": "NULL.NULL|NULL.BOOL|NULL.INT|NULL.FLOAT|NULL.DECIMAL|NULL.TIMESTAMP|NULL.STRING|NULL.SYMBOL|NULL.BLOB|NULL.CLOB|NULL.STRUCT|NULL.LIST|NULL.SEXP|NULL"
