...
//#region node_modules/ace-code/src/mode/csound_preprocessor_highlight_rules.js
		...
		this.pushRule = function(params) {
			...
			return {
				...
				onMatch: function(value, currentState, stack, line) {
					...
					if (Array.isArray(params.next)) for (var i = 0; i < params.next.length; i++) stack.push(params.next[i]);
...
//#endregion
//#region node_modules/ace-code/src/mode/csound_score_highlight_rules.js
