...
import { t as require_sql } from "./sql-t1NSXk8B.js";
...
var require_plsql_highlight_rules = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var plsqlHighlightRules = function() {
		var keywordMapper = this.createKeywordMapper({
			...
			"storage.type": "char|nchar|nvarchar2|varchar2|long|raw|number|numeric|float|dec|decimal|integer|int|smallint|real|double|precision|date|timestamp|interval|year|day|bfile|blob|clob|nclob|rowid|urowid"
		}, "identifier", true);
		this.$rules = { "start": [
			{
				token: "comment",
