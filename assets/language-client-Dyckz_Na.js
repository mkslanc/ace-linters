...
import { M as require_main$1, k as mergeObjects, y as MessageType } from "./message-types-M_uv5dSK.js";
...
function createWebSocketConnection(socket, logger) {
	const connection = (0, import_main$2.createMessageConnection)(new WebSocketMessageReader(socket), new WebSocketMessageWriter(socket), logger);
