...
manager.registerService("html", {
	...
	module: () => import("./html-service-Binm5IJu.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "HtmlService",
	modes: "html"
});
manager.registerService("css", {
	features: { signatureHelp: false },
	module: () => import("./css-service-BIjkGyts.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("json", {
	...
	module: () => import("./json-service-FUgiIaIg.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("typescript", {
	module: () => import("./typescript-service-Dv3oKAyl.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("lua", {
	...
	module: () => import("./ace-lua-linter-CoOb5-pC.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("yaml", {
	...
	module: () => import("./yaml-service-Dgx4JDd-.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("xml", {
	...
	module: () => import("./xml-service-CSo8RG9t.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("php", {
	...
	module: () => import("./php-service-DKSiNVh8.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("javascript", {
	...
	module: () => import("./javascript-service-C3mYDUu-.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("python", {
	...
	module: () => import("./python-service-BjbhjOPC.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "PythonService",
	modes: "python"
});
manager.registerService("mysql", {
	module: () => import("./mysql-service-BCueX9EV.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "MySQLService",
	modes: "mysql"
});
manager.registerService("clang", {
	module: () => import("./ace-clang-linter-BkuDDfXG.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "AceClangLinter",
	modes: "c_cpp"
});
manager.registerService("zig", {
	module: () => import("./ace-zig-linter-wdSOFqpX.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "AceZigLinter",
	modes: "zig"
});
manager.registerService("dart", {
	module: () => import("./ace-dart-linter-CUKk_spB.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "AceDartLinter",
	modes: "dart"
});
manager.registerService("golang", {
	module: () => import("./ace-go-linter-CnHNFvYb.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
