...
//#region node_modules/ace-code/src/ext/searchbox-css.js
var require_searchbox_css = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = `
...
//#endregion
//#region node_modules/ace-code/src/ext/searchbox.js
/**
...
* @module
*/
var require_searchbox = /* @__PURE__ */ __commonJSMin(((exports) => {
	/**
	...
	var SearchBox = class {
		...
		*/
		...
		$init() {
			...
			event.addListener(sb, "click", function(e) {
				var action = (e.target || e.srcElement).getAttribute("action");
		...
		setSearchRange(range) {
			...
			if (range) this.searchRangeMarker = this.editor.session.addMarker(range, "ace_active-line");
		...
		*/
		find(skipCurrent, backwards, preventScroll) {
			...
			/**@type {any}*/
			var noMatch = !this.editor.find(this.searchInput.value, {
				skipCurrent,
				backwards,
				wrap: true,
		...
		findAll() {
			/**@type {any}*/
			var noMatch = !this.editor.findAll(this.searchInput.value, {
				regExp: this.regExpOption.checked,
				caseSensitive: this.caseSensitiveOption.checked,
				wholeWord: this.wholeWordOption.checked
			}) && this.searchInput.value;
		...
		*/
		show(value, isReplace) {
			...
			if (value != void 0) this.searchInput.value = value;
