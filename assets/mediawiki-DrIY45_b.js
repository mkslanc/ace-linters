...
var require_mediawiki_highlight_rules = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop$1 = require_oop();
	var TextHighlightRules = require_text_highlight_rules().TextHighlightRules;
	var MediaWikiHighlightRules$1 = function() {
		this.$rules = {
			start: [
				{ include: "#switch" },
				{ include: "#redirect" },
	...
	MediaWikiHighlightRules$1.metaData = {
		name: "MediaWiki",
		scopeName: "text.html.mediawiki",
		fileTypes: ["mediawiki", "wiki"]
	};
	oop$1.inherits(MediaWikiHighlightRules$1, TextHighlightRules);
	exports.MediaWikiHighlightRules = MediaWikiHighlightRules$1;
}));
var require_mediawiki = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop = require_oop();
