...
manager.registerService("html", {
	...
	module: () => import("./html-service-DndcXICR.js"),
	className: "HtmlService",
	modes: "html"
});
manager.registerService("css", {
	features: { signatureHelp: false },
	module: () => import("./css-service-DzO5pcA4.js"),
...
manager.registerService("json", {
	...
	module: () => import("./json-service-DnDKe2uQ.js"),
...
manager.registerService("lua", {
	...
	module: () => import("./lua-service-CF3A1JEh.js"),
...
manager.registerService("yaml", {
	...
	module: () => import("./yaml-service-C9rrzhZP.js"),
...
manager.registerService("xml", {
	...
	module: () => import("./xml-service-BRTDkdK5.js"),
...
manager.registerService("php", {
	...
	module: () => import("./php-service-DKjSND1D.js"),
	className: "PhpService",
	modes: "php"
});
manager.registerServer("pythonls", {
	module: () => import("./language-client-DKoMqyXU.js"),
	modes: "python",
	type: "socket",
...
manager.registerService("mysql", {
	module: () => import("./mysql-service-LRLhWSAR.js"),
...
export { Utils as a, URI as i, checkValueAgainstRegexpArray as n, mergeObjects as r, MessageType as t };
