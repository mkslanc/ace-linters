import { a as __toESM, t as __commonJSMin } from "./modulepreload-polyfill-DxDZhch-.js";
//#region node_modules/ace-builds/src-noconflict/ace.js
var require_ace = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/**
	...
	*/
	(function() {
		...
		var define = function(module$20, deps, payload) {
			if (typeof module$20 !== "string") {
			...
			if (!define.modules[module$20]) {
				define.payloads[module$20] = payload;
				define.modules[module$20] = null;
			}
		};
		define.modules = {};
		define.payloads = {};
		...
		*/
		var _require = function(parentId, module$21, callback) {
			if (typeof module$21 === "string") {
				var payload = lookup(parentId, module$21);
				if (payload != void 0) {
					callback && callback();
					return payload;
				}
			} else if (Object.prototype.toString.call(module$21) === "[object Array]") {
				var params = [];
				for (var i = 0, l = module$21.length; i < l; ++i) {
					var dep = lookup(parentId, module$21[i]);
		...
		var require = function(module$22, callback) {
			var packagedModule = _require("", module$22, callback);
			if (packagedModule == void 0 && require.original) return require.original.apply(this, arguments);
		...
		*/
		var lookup = function(parentId, moduleName) {
			...
			var module$23 = define.modules[moduleName];
			if (!module$23) {
				module$23 = define.payloads[moduleName];
				if (typeof module$23 === "function") {
					var exports$20 = {};
					var mod = {
						id: moduleName,
						uri: "",
					...
					var req = function(module$24, callback) {
						return _require(moduleName, module$24, callback);
					};
					exports$20 = module$23(req, exports$20, mod) || mod.exports;
					define.modules[moduleName] = exports$20;
					delete define.payloads[moduleName];
				}
				module$23 = define.modules[moduleName] = exports$20 || module$23;
			}
			return module$23;
		};
	...
	ace.define("ace/lib/es6-shim", [
		...
		"exports",
		"module"
	], function(require, exports$21, module$25) {
		...
		if (!String.prototype.endsWith) defineProp(String.prototype, "endsWith", function(searchString, position) {
			...
			if (position === void 0 || position > subjectString.length) position = subjectString.length;
		...
		if (!Object.assign) Object.assign = function(target) {
			...
			for (var index = 1; index < arguments.length; index++) {
				...
				if (source !== void 0 && source !== null) Object.keys(source).forEach(function(key) {
	...
	ace.define("ace/lib/fixoldbrowsers", [
		...
		"module",
		"ace/lib/es6-shim"
	], function(require, exports$22, module$26) {
		"use strict";
		require("./es6-shim");
	});
	ace.define("ace/lib/deep_copy", [
		...
		"exports",
		"module"
	], function(require, exports$23, module$27) {
		exports$23.deepCopy = function deepCopy(obj) {
	...
	ace.define("ace/lib/lang", [
		...
		"module",
		"ace/lib/deep_copy"
	], function(require, exports$24, module$28) {
		"use strict";
		exports$24.last = function(a) {
			return a[a.length - 1];
		};
		exports$24.stringReverse = function(string) {
			return string.split("").reverse().join("");
		};
		exports$24.stringRepeat = function(string, count) {
			var result = "";
			while (count > 0) {
				if (count & 1) result += string;
				if (count >>= 1) string += string;
		...
		exports$24.stringTrimLeft = function(string) {
			return string.replace(trimBeginRegexp, "");
		};
		exports$24.stringTrimRight = function(string) {
			return string.replace(trimEndRegexp, "");
		};
		exports$24.copyObject = function(obj) {
			var copy = {};
			for (var key in obj) copy[key] = obj[key];
			return copy;
		};
		exports$24.copyArray = function(array) {
			var copy = [];
			for (var i = 0, l = array.length; i < l; i++) if (array[i] && typeof array[i] == "object") copy[i] = this.copyObject(array[i]);
			else copy[i] = array[i];
			return copy;
		};
		exports$24.deepCopy = require("./deep_copy").deepCopy;
		exports$24.arrayToMap = function(arr) {
			var map = {};
			for (var i = 0; i < arr.length; i++) map[arr[i]] = 1;
			return map;
		};
		exports$24.createMap = function(props) {
			var map = Object.create(null);
			for (var i in props) map[i] = props[i];
			return map;
		};
		exports$24.arrayRemove = function(array, value) {
			for (var i = 0; i <= array.length; i++) if (value === array[i]) array.splice(i, 1);
		};
		exports$24.escapeRegExp = function(str) {
			return str.replace(/([.*+?^${}()|[\]\/\\])/g, "\\$1");
		};
		exports$24.escapeHTML = function(str) {
			return ("" + str).replace(/&/g, "&#38;").replace(/"/g, "&#34;").replace(/'/g, "&#39;").replace(/</g, "&#60;");
		};
		exports$24.getMatchOffsets = function(string, regExp) {
			var matches = [];
		...
		exports$24.deferredCall = function(fcn) {
			var timer = null;
		...
		exports$24.delayedCall = function(fcn, defaultTimeout) {
			var timer = null;
			var callback = function() {
				timer = null;
				fcn();
		...
		exports$24.sleep = function(ms) {
			return new Promise(function(resolve) {
				setTimeout(resolve, ms);
			});
		};
		exports$24.supportsLookbehind = function() {
			return true;
		};
		exports$24.skipEmptyMatch = function(line, last, supportsUnicodeFlag) {
	...
	ace.define("ace/lib/useragent", [
		...
		"exports",
		"module"
	], function(require, exports$25, module$29) {
		"use strict";
		exports$25.OS = {
			LINUX: "LINUX",
			MAC: "MAC",
		...
		exports$25.getOS = function() {
			if (exports$25.isMac) return exports$25.OS.MAC;
			else if (exports$25.isLinux) return exports$25.OS.LINUX;
			else return exports$25.OS.WINDOWS;
		};
		var _navigator = typeof navigator == "object" ? navigator : {};
		var os = (/mac|win|linux/i.exec(_navigator.platform) || ["other"])[0].toLowerCase();
		var ua = _navigator.userAgent || "";
		var appName = _navigator.appName || "";
		exports$25.isWin = os == "win";
		exports$25.isMac = os == "mac";
		exports$25.isLinux = os == "linux";
		exports$25.isIE = appName == "Microsoft Internet Explorer" || appName.indexOf("MSAppHost") >= 0 ? parseFloat((ua.match(/(?:MSIE |Trident\/[0-9]+[\.0-9]+;.*rv:)([0-9]+[\.0-9]+)/) || [])[1]) : parseFloat((ua.match(/(?:Trident\/[0-9]+[\.0-9]+;.*rv:)([0-9]+[\.0-9]+)/) || [])[1]);
		exports$25.isOldIE = exports$25.isIE && exports$25.isIE < 9;
		exports$25.isGecko = exports$25.isMozilla = ua.match(/ Gecko\/\d+/);
		exports$25.isOpera = typeof opera == "object" && Object.prototype.toString.call(window["opera"]) == "[object Opera]";
		exports$25.isWebKit = parseFloat(ua.split("WebKit/")[1]) || void 0;
		exports$25.isChrome = parseFloat(ua.split(" Chrome/")[1]) || void 0;
		exports$25.isSafari = parseFloat(ua.split(" Safari/")[1]) && !exports$25.isChrome || void 0;
		exports$25.isEdge = parseFloat(ua.split(" Edge/")[1]) || void 0;
		exports$25.isAIR = ua.indexOf("AdobeAIR") >= 0;
		exports$25.isAndroid = ua.indexOf("Android") >= 0;
		exports$25.isChromeOS = ua.indexOf(" CrOS ") >= 0;
		exports$25.isIOS = /iPad|iPhone|iPod/.test(ua) && !window["MSStream"];
		if (exports$25.isIOS) exports$25.isMac = true;
		exports$25.isMobile = exports$25.isIOS || exports$25.isAndroid;
	});
	ace.define("ace/lib/dom", [
		...
		"module",
		"ace/lib/useragent"
	], function(require, exports$26, module$30) {
		"use strict";
		var useragent = require("./useragent");
		var XHTML_NS = "http://www.w3.org/1999/xhtml";
		exports$26.buildDom = function buildDom(arr, parent, refs) {
		...
		exports$26.getDocumentHead = function(doc) {
			if (!doc) doc = document;
			return doc.head || doc.getElementsByTagName("head")[0] || doc.documentElement;
		};
		exports$26.createElement = function(tag, ns) {
			return document.createElementNS ? document.createElementNS(ns || XHTML_NS, tag) : document.createElement(tag);
		};
		exports$26.removeChildren = function(element) {
			element.innerHTML = "";
		};
		exports$26.createTextNode = function(textContent, element) {
			return (element ? element.ownerDocument : document).createTextNode(textContent);
		};
		exports$26.createFragment = function(element) {
			return (element ? element.ownerDocument : document).createDocumentFragment();
		};
		exports$26.hasCssClass = function(el, name) {
			return (el.className + "").split(/\s+/g).indexOf(name) !== -1;
		};
		exports$26.addCssClass = function(el, name) {
			if (!exports$26.hasCssClass(el, name)) el.className += " " + name;
		};
		exports$26.removeCssClass = function(el, name) {
		...
		exports$26.toggleCssClass = function(el, name) {
		...
		exports$26.setCssClass = function(node, className, include) {
			if (include) exports$26.addCssClass(node, className);
			else exports$26.removeCssClass(node, className);
		};
		exports$26.hasCssString = function(id, doc) {
			var index = 0, sheets;
			doc = doc || document;
		...
		exports$26.removeElementById = function(id, doc) {
			doc = doc || document;
			if (doc.getElementById(id)) doc.getElementById(id).remove();
		};
		var strictCSP;
		var cssCache = [];
		exports$26.useStrictCSP = function(value) {
			strictCSP = value;
		...
		function importCssString(cssText, id, target) {
			...
			if (id && exports$26.hasCssString(id, container)) return null;
			if (id) cssText += "\n/*# sourceURL=ace/css/" + id + " */";
			var style = exports$26.createElement("style");
			style.appendChild(doc.createTextNode(cssText));
			if (id) style.id = id;
			if (container == doc) container = exports$26.getDocumentHead(doc);
			container.insertBefore(style, container.firstChild);
		}
		exports$26.importCssString = importCssString;
		exports$26.importCssStylsheet = function(uri, doc) {
			exports$26.buildDom(["link", {
				rel: "stylesheet",
				href: uri
			}], exports$26.getDocumentHead(doc));
		};
		exports$26.$fixPositionBug = function(el) {
			var rect = el.getBoundingClientRect();
			if (el.style.left) {
				var target = parseFloat(el.style.left);
				var result = +rect.left;
				if (Math.abs(target - result) > 1) el.style.left = 2 * target - result + "px";
			}
			if (el.style.right) {
				var target = parseFloat(el.style.right);
				var result = window.innerWidth - rect.right;
				if (Math.abs(target - result) > 1) el.style.right = 2 * target - result + "px";
			}
			if (el.style.top) {
				var target = parseFloat(el.style.top);
				var result = +rect.top;
				if (Math.abs(target - result) > 1) el.style.top = 2 * target - result + "px";
			}
			if (el.style.bottom) {
				var target = parseFloat(el.style.bottom);
				var result = window.innerHeight - rect.bottom;
				if (Math.abs(target - result) > 1) el.style.bottom = 2 * target - result + "px";
			}
		};
		exports$26.scrollbarWidth = function(doc) {
			var inner = exports$26.createElement("ace_inner");
			inner.style.width = "100%";
			inner.style.minWidth = "0px";
			inner.style.height = "200px";
			inner.style.display = "block";
			var outer = exports$26.createElement("ace_outer");
		...
		exports$26.computedStyle = function(element, style) {
			return window.getComputedStyle(element, "") || {};
		};
		exports$26.setStyle = function(styles, property, value) {
			if (styles[property] !== value) styles[property] = value;
		};
		exports$26.HAS_CSS_ANIMATION = false;
		exports$26.HAS_CSS_TRANSFORMS = false;
		exports$26.HI_DPI = useragent.isWin ? typeof window !== "undefined" && window.devicePixelRatio >= 1.5 : true;
		if (useragent.isChromeOS) exports$26.HI_DPI = false;
		if (typeof document !== "undefined") {
			var div = document.createElement("div");
			if (exports$26.HI_DPI && div.style.transform !== void 0) exports$26.HAS_CSS_TRANSFORMS = true;
			if (!useragent.isEdge && typeof div.style.animationName !== "undefined") exports$26.HAS_CSS_ANIMATION = true;
			div = null;
		}
		if (exports$26.HAS_CSS_TRANSFORMS) exports$26.translate = function(element, tx, ty) {
			element.style.transform = "translate(" + Math.round(tx) + "px, " + Math.round(ty) + "px)";
		};
		else exports$26.translate = function(element, tx, ty) {
	...
	ace.define("ace/lib/net", [
		...
		"module",
		"ace/lib/dom"
	], function(require, exports$27, module$31) {
		/*
		* based on code from:
		*
		...
		*/
		"use strict";
		var dom = require("./dom");
		exports$27.get = function(url, callback) {
		...
		exports$27.loadScript = function(path, callback) {
		...
		exports$27.qualifyURL = function(url) {
	...
	ace.define("ace/lib/oop", [
		...
		"exports",
		"module"
	], function(require, exports$28, module$32) {
		"use strict";
		exports$28.inherits = function(ctor, superCtor) {
		...
		exports$28.mixin = function(obj, mixin) {
			for (var key in mixin) obj[key] = mixin[key];
			return obj;
		};
		exports$28.implement = function(proto, mixin) {
			exports$28.mixin(proto, mixin);
		};
	});
	ace.define("ace/lib/event_emitter", [
		...
		"exports",
		"module"
	], function(require, exports$29, module$33) {
		"use strict";
		var EventEmitter = {};
		...
		exports$29.EventEmitter = EventEmitter;
	});
	ace.define("ace/lib/report_error", [
		"require",
		"exports",
		"module"
	], function(require, exports$30, module$34) {
		exports$30.reportError = function reportError(msg, data) {
			var e = new Error(msg);
			e["data"] = data;
	...
	ace.define("ace/lib/default_english_messages", [
		...
		"exports",
		"module"
	], function(require, exports$31, module$35) {
		exports$31.defaultEnglishMessages = {
	...
	], function(require, exports$32, module$36) {
		"no use strict";
		var oop = require("./oop");
	...
	ace.define("ace/theme/textmate", [
		...
		"ace/lib/dom"
	], function(require, exports$34, module$38) {
		"use strict";
		exports$34.isDark = false;
		exports$34.cssClass = "ace-tm";
		exports$34.cssText = require("./textmate-css");
		exports$34.$id = "ace/theme/textmate";
		require("../lib/dom").importCssString(exports$34.cssText, exports$34.cssClass, false);
	});
	ace.define("ace/config", [
		...
		"ace/lib/app_config",
		"ace/theme/textmate"
	], function(require, exports$35, module$39) {
		"no use strict";
		var lang = require("./lib/lang");
		var net = require("./lib/net");
		var dom = require("./lib/dom");
		var AppConfig = require("./lib/app_config").AppConfig;
		module$39.exports = exports$35 = new AppConfig();
		var options = {
			packaged: false,
			workerPath: null,
			modePath: null,
		...
		exports$35.all = function() {
			return lang.copyObject(options);
		};
		exports$35.$modes = {};
		exports$35.moduleUrl = function(name, component) {
		...
		exports$35.setModuleUrl = function(name, subst) {
		...
		var customLoader;
		exports$35.setLoader = function(cb) {
			customLoader = cb;
		};
		exports$35.dynamicModules = Object.create(null);
		exports$35.$loading = {};
		exports$35.$loaded = {};
		exports$35.loadModule = function(moduleId, onLoad) {
			var loadedModule;
			if (Array.isArray(moduleId)) {
				var moduleType = moduleId[0];
				var moduleName = moduleId[1];
			} else if (typeof moduleId == "string") var moduleName = moduleId;
			var load = function(module$40) {
				if (module$40 && !exports$35.$loading[moduleName]) return onLoad && onLoad(module$40);
				if (!exports$35.$loading[moduleName]) exports$35.$loading[moduleName] = [];
				exports$35.$loading[moduleName].push(onLoad);
				if (exports$35.$loading[moduleName].length > 1) return;
				var afterLoad = function() {
					loader(moduleName, function(err, module$41) {
						if (module$41) exports$35.$loaded[moduleName] = module$41;
						exports$35._emit("load.module", {
							name: moduleName,
							module: module$41
						});
						var listeners = exports$35.$loading[moduleName];
						exports$35.$loading[moduleName] = null;
						listeners.forEach(function(onLoad) {
							onLoad && onLoad(module$41);
						});
					});
				};
				if (!exports$35.get("packaged")) return afterLoad();
				net.loadScript(exports$35.moduleUrl(moduleName, moduleType), afterLoad);
				reportErrorIfPathIsNotConfigured();
			};
			if (exports$35.dynamicModules[moduleName]) exports$35.dynamicModules[moduleName]().then(function(module$42) {
				if (module$42.default) load(module$42.default);
				else load(module$42);
			});
			else {
				try {
				...
				load(loadedModule || exports$35.$loaded[moduleName]);
			}
		};
		exports$35.$require = function(moduleName) {
			if (typeof module$39["require"] == "function") return module$39["require"](moduleName);
		};
		exports$35.setModuleLoader = function(moduleName, onLoad) {
			exports$35.dynamicModules[moduleName] = onLoad;
		};
	...
	ace.define("ace/loader_build", [
		...
		"ace/config"
	], function(require, exports$36, module$43) {
		"use strict";
		require("./lib/fixoldbrowsers");
		var config = require("./config");
		config.setLoader(function(moduleName, cb) {
			require([moduleName], function(module$44) {
				cb(null, module$44);
			});
		});
		var global = (function() {
		...
		module$43.exports = function(ace) {
			config.init = init;
		...
		function init(packaged) {
			...
			config.set("packaged", packaged || require.packaged || module$43.packaged || global.define && define.packaged);
			var scriptOptions = {};
			var scriptUrl = "";
	...
	ace.define("ace/range", [
		...
		"exports",
		"module"
	], function(require, exports$37, module$45) {
		"use strict";
		var Range = function() {
	...
	ace.define("ace/lib/keys", [
		...
		"module",
		"ace/lib/oop"
	], function(require, exports$38, module$46) {
		"use strict";
		var oop = require("./oop");
		var Keys = {
			MODIFIER_KEYS: {
		...
		exports$38.$codeToKeyCode = codeToKeyCode;
		...
		oop.mixin(exports$38, Keys);
		exports$38.default = exports$38;
		exports$38.keyCodeToString = function(keyCode) {
	...
	ace.define("ace/lib/event", [
		...
		"ace/lib/keys",
		"ace/lib/useragent"
	], function(require, exports$39, module$47) {
		"use strict";
		...
		var addListener = exports$39.addListener = function(elem, type, callback, destroyer) {
			elem.addEventListener(type, callback, getListenerOptions());
			if (destroyer) destroyer.$toDestroy.push(new EventListener(elem, type, callback));
		};
		var removeListener = exports$39.removeListener = function(elem, type, callback) {
			elem.removeEventListener(type, callback, getListenerOptions());
		};
		exports$39.stopEvent = function(e) {
			exports$39.stopPropagation(e);
			exports$39.preventDefault(e);
			return false;
		};
		exports$39.stopPropagation = function(e) {
			if (e.stopPropagation) e.stopPropagation();
		};
		exports$39.preventDefault = function(e) {
			if (e.preventDefault) e.preventDefault();
		};
		exports$39.getButton = function(e) {
			if (e.type == "dblclick") return 0;
			if (e.type == "contextmenu" || useragent.isMac && e.ctrlKey && !e.altKey && !e.shiftKey) return 2;
			return e.button;
		};
		exports$39.capture = function(el, eventHandler, releaseCaptureHandler) {
		...
		exports$39.addMouseWheelListener = function(el, callback, destroyer) {
		...
		exports$39.addMultiMouseDownListener = function(elements, timeouts, eventHandler, callbackName, destroyer) {
			var clicks = 0;
			...
			function onMousedown(e) {
				if (exports$39.getButton(e) !== 0) clicks = 0;
				else if (e.detail > 1) {
					clicks++;
		...
		exports$39.getModifierString = function(e) {
		...
		exports$39.addCommandKeyListener = function(el, callback, destroyer) {
		...
		if (typeof window == "object" && window.postMessage && !useragent.isOldIE) {
			var postMessageId = 1;
			exports$39.nextTick = function(callback, win) {
				win = win || window;
		...
		exports$39.$idleBlocked = false;
		exports$39.onIdle = function(cb, timeout) {
			return setTimeout(function handler() {
				if (!exports$39.$idleBlocked) cb();
				else setTimeout(handler, 100);
			}, timeout);
		};
		exports$39.$idleBlockId = null;
		exports$39.blockIdle = function(delay) {
			if (exports$39.$idleBlockId) clearTimeout(exports$39.$idleBlockId);
			exports$39.$idleBlocked = true;
			exports$39.$idleBlockId = setTimeout(function() {
				exports$39.$idleBlocked = false;
			}, delay || 100);
		};
		exports$39.nextFrame = typeof window == "object" && (window.requestAnimationFrame || window["mozRequestAnimationFrame"] || window["webkitRequestAnimationFrame"] || window["msRequestAnimationFrame"] || window["oRequestAnimationFrame"]);
		if (exports$39.nextFrame) exports$39.nextFrame = exports$39.nextFrame.bind(window);
		else exports$39.nextFrame = function(callback) {
	...
	ace.define("ace/clipboard", [
		...
		"exports",
		"module"
	], function(require, exports$40, module$48) {
		"use strict";
		var $cancelT;
		module$48.exports = {
			lineMode: false,
	...
	ace.define("ace/keyboard/textinput", [
		...
		"ace/clipboard",
		"ace/lib/keys"
	], function(require, exports$41, module$49) {
		"use strict";
		...
		exports$41.TextInput = function() {
			function TextInput(parentNode, host) {
				...
				if (!("oncut" in this.text) || !("oncopy" in this.text) || !("onpaste" in this.text)) event.addListener(parentNode, "keydown", function(e) {
			...
			TextInput.prototype.addIosSelectionHandler = function(parentNode, host, text) {
				...
				var detectArrowKeys = function(e) {
					...
					if (selectionStart == 0) key = KEYS.up;
					...
					} else if (selectionStart < _this.lastSelectionStart || selectionStart == _this.lastSelectionStart && _this.lastSelectionEnd != _this.lastSelectionStart && selectionStart == selectionEnd) key = KEYS.left;
						...
						key = KEYS.right;
						modifier = MODS.option;
					} else if (selectionEnd > _this.lastSelectionEnd || selectionEnd == _this.lastSelectionEnd && _this.lastSelectionEnd != _this.lastSelectionStart && selectionStart == selectionEnd) key = KEYS.right;
			...
			TextInput.prototype.$resetSelection = function() {
				...
				var positionToSelection = function(row, column) {
					...
					for (var i = 1; i <= row - _this.rowStart && i < 2 * _this.numberOfExtraLines + 1; i++) selection += _this.host.session.getLine(row - i).length + 1;
					return selection;
				};
				if (this.host.session) {
					...
					var lines = [];
					for (var i = this.rowStart; i <= this.rowEnd; i++) lines.push(this.host.session.getLine(i));
					line = lines.join("\n");
			...
			TextInput.prototype.setAriaLabel = function() {
				var ariaLabel = "";
				if (this.host.$textInputAriaLabel) ariaLabel += "".concat(this.host.$textInputAriaLabel, ", ");
				if (this.host.session) {
			...
			TextInput.prototype.moveToMouse = function(e, bringToFront) {
				...
				this.text.style.cssText = (bringToFront ? "z-index:100000;" : "") + (useragent.isIE ? "opacity:0.1;" : "") + "text-indent: -" + (this.lastSelectionStart + this.lastSelectionEnd) * this.host.renderer.characterWidth * .5 + "px;";
		...
		exports$41.$setUserAgentForTests = function(_isMobile, _isIOS) {
			isMobile = _isMobile;
			isIOS = _isIOS;
		};
	});
	ace.define("ace/mouse/default_handlers", [
		...
		"module",
		"ace/lib/useragent"
	], function(require, exports$42, module$50) {
		"use strict";
		var useragent = require("../lib/useragent");
		var DRAG_OFFSET = 0;
		...
		var DefaultHandlers = function() {
			...
			DefaultHandlers.prototype.focusWait = function() {
				if (calcDistance(this.mousedownEvent.x, this.mousedownEvent.y, this.x, this.y) > DRAG_OFFSET || Date.now() - this.mousedownEvent.time > this.$focusTimeout) this.startSelect(this.mousedownEvent.getDocumentPosition());
			};
		...
		exports$42.DefaultHandlers = DefaultHandlers;
	...
	ace.define("ace/mouse/mouse_event", [
		...
		"ace/lib/event",
		"ace/lib/useragent"
	], function(require, exports$43, module$51) {
		"use strict";
		var event = require("../lib/event");
		var useragent = require("../lib/useragent");
		exports$43.MouseEvent = function() {
	...
	ace.define("ace/lib/scroll", [
		...
		"exports",
		"module"
	], function(require, exports$44, module$52) {
		exports$44.preventParentScroll = function preventParentScroll(event) {
	...
	ace.define("ace/tooltip", [
		...
		"ace/range",
		"ace/lib/scroll"
	], function(require, exports$45, module$53) {
		"use strict";
		...
		exports$45.popupManager = popupManager;
		exports$45.Tooltip = Tooltip;
		exports$45.HoverTooltip = function(_super) {
	...
	ace.define("ace/mouse/default_gutter_handler", [
		...
		"ace/config",
		"ace/range"
	], function(require, exports$46, module$54) {
		"use strict";
		var __extends = this && this.__extends || (function() {
			var extendStatics = function(d, b) {
				extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		...
		exports$46.GutterHandler = GutterHandler;
		...
		GutterTooltip.$uid = 0;
		exports$46.GutterTooltip = GutterTooltip;
	});
	ace.define("ace/mouse/dragdrop_handler", [
		...
		"ace/lib/event",
		"ace/lib/useragent"
	], function(require, exports$47, module$55) {
		"use strict";
		var dom = require("../lib/dom");
		var event = require("../lib/event");
		var useragent = require("../lib/useragent");
		...
		exports$47.DragdropHandler = DragdropHandler;
	});
	ace.define("ace/mouse/touch_handler", [
		...
		"ace/lib/event",
		"ace/lib/dom"
	], function(require, exports$48, module$56) {
		"use strict";
		var MouseEvent = require("./mouse_event").MouseEvent;
		var event = require("../lib/event");
		var dom = require("../lib/dom");
		exports$48.addTouchListeners = function(el, editor) {
			var mode = "scroll";
			var startX;
			var startY;
			var touchStartT;
			...
			function createContextMenu() {
				...
				var handleClick = function(e) {
					...
					if (action == "paste") clipboard.readText().then(function(text) {
						...
						if (action == "cut" || action == "copy") if (clipboard) clipboard.writeText(editor.getCopyText());
	...
	ace.define("ace/mouse/mouse_handler", [
		...
		"ace/config"
	], function(require, exports$49, module$57) {
		"use strict";
		var event = require("../lib/event");
		var useragent = require("../lib/useragent");
		...
		exports$49.MouseHandler = MouseHandler;
	});
	ace.define("ace/mouse/fold_handler", [
		...
		"module",
		"ace/lib/dom"
	], function(require, exports$50, module$58) {
		"use strict";
		var dom = require("../lib/dom");
		exports$50.FoldHandler = function() {
	...
	ace.define("ace/keyboard/keybinding", [
		...
		"ace/lib/keys",
		"ace/lib/event"
	], function(require, exports$51, module$59) {
		"use strict";
		var keyUtil = require("../lib/keys");
		var event = require("../lib/event");
		exports$51.KeyBinding = function() {
	...
	ace.define("ace/lib/bidiutil", [
		...
		"exports",
		"module"
	], function(require, exports$52, module$60) {
		"use strict";
		...
		exports$52.RLE = 7;
		exports$52.DOT = "·";
		exports$52.doBidiReorder = function(text, textCharTypes, isRtl) {
			...
			for (var i = 0; i < logicalFromVisual.length - 1; i++) if (textCharTypes[i] === AN) levels[i] = exports$52.AN;
			else if (levels[i] === R && (textCharTypes[i] > AL && textCharTypes[i] < LRE || textCharTypes[i] === ON || textCharTypes[i] === BN)) levels[i] = exports$52.ON_R;
			else if (i > 0 && chars[i - 1] === "ل" && /\u0622|\u0623|\u0625|\u0627/.test(chars[i])) {
				levels[i - 1] = levels[i] = exports$52.R_H;
				i++;
			}
			if (chars[chars.length - 1] === exports$52.DOT) levels[chars.length - 1] = exports$52.B;
			if (chars[0] === "‫") levels[0] = exports$52.RLE;
		...
		exports$52.hasBidiCharacters = function(text, textCharTypes) {
			var ret = false;
		...
		exports$52.getVisualFromLogicalIdx = function(logIdx, rowMap) {
	...
	ace.define("ace/bidihandler", [
		...
		"ace/lib/bidiutil",
		"ace/lib/lang"
	], function(require, exports$53, module$61) {
		"use strict";
		var bidiUtil = require("./lib/bidiutil");
		var lang = require("./lib/lang");
		var bidiRE = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac\u202B]/;
		exports$53.BidiHandler = function() {
	...
	ace.define("ace/selection", [
		...
		"ace/lib/event_emitter",
		"ace/range"
	], function(require, exports$54, module$62) {
		"use strict";
		...
		exports$54.Selection = Selection;
	});
	ace.define("ace/tokenizer", [
		...
		"module",
		"ace/lib/report_error"
	], function(require, exports$55, module$63) {
		"use strict";
		...
		var Tokenizer = function() {
			function Tokenizer(rules) {
				...
				for (var key in this.states) {
					...
					for (var i = 0; i < state.length; i++) {
						...
						if (Array.isArray(rule.token)) if (rule.token.length == 1 || matchcount == 1) rule.token = rule.token[0];
						...
						else if (typeof rule.token == "function" && !rule.onMatch) if (matchcount > 1) rule.onMatch = this.$applyToken;
			...
			Tokenizer.prototype.getLineTokens = function(line, startState) {
				...
				while (match = re.exec(line)) {
					...
					if (value) {
						if (typeof type === "string") if ((!rule || rule.merge !== false) && token.type === type) token.value += value;
						else {
							if (token.type) tokens.push(token);
							token = {
								type,
		...
		exports$55.Tokenizer = Tokenizer;
	});
	ace.define("ace/mode/text_highlight_rules", [
		...
		"module",
		"ace/lib/deep_copy"
	], function(require, exports$56, module$64) {
		"use strict";
		...
		exports$56.TextHighlightRules = TextHighlightRules;
	});
	ace.define("ace/mode/behaviour", [
		"require",
		"exports",
		"module"
	], function(require, exports$57, module$65) {
		"use strict";
		...
		exports$57.Behaviour = Behaviour;
	});
	ace.define("ace/token_iterator", [
		...
		"module",
		"ace/range"
	], function(require, exports$58, module$66) {
		"use strict";
		var Range = require("./range").Range;
		exports$58.TokenIterator = function() {
	...
	ace.define("ace/mode/behaviour/cstyle", [
		...
		"ace/token_iterator",
		"ace/lib/lang"
	], function(require, exports$59, module$67) {
		"use strict";
		var oop = require("../../lib/oop");
			...
			this.add("braces", "insertion", function(state, action, editor, session, text) {
				...
				if (text == "{") {
					...
					if (selected !== "" && selected !== "{" && editor.getWrapBehavioursEnabled()) return getWrapped(selection, selected, "{", "}");
						...
						if ([/tag\-(?:open|name)/, /attribute\-name/].some(function(el) {
		...
		exports$59.CstyleBehaviour = CstyleBehaviour;
	});
	ace.define("ace/unicode", [
		"require",
		"exports",
		"module"
	], function(require, exports$60, module$68) {
		"use strict";
		var wordChars = [
			48,
			9,
		...
		exports$60.wordChars = String.fromCharCode.apply(null, str);
	});
	ace.define("ace/mode/text", [
		...
		"ace/token_iterator",
		"ace/range"
	], function(require, exports$61, module$69) {
		"use strict";
		var config = require("../config");
	...
	ace.define("ace/line_widgets", [
		...
		"module",
		"ace/lib/dom"
	], function(require, exports$62, module$70) {
		"use strict";
		var dom = require("./lib/dom");
		exports$62.LineWidgets = function() {
	...
	ace.define("ace/apply_delta", [
		...
		"exports",
		"module"
	], function(require, exports$63, module$71) {
		"use strict";
		exports$63.applyDelta = function(docLines, delta, doNotValidate) {
	...
	ace.define("ace/anchor", [
		...
		"ace/lib/oop",
		"ace/lib/event_emitter"
	], function(require, exports$64, module$72) {
		"use strict";
		var oop = require("./lib/oop");
		var EventEmitter = require("./lib/event_emitter").EventEmitter;
		var Anchor = function() {
	...
	ace.define("ace/document", [
		...
		"ace/range",
		"ace/anchor"
	], function(require, exports$65, module$73) {
		"use strict";
		var oop = require("./lib/oop");
		...
		var Document = function() {
			...
			Document.prototype.removeFullLines = function(firstRow, lastRow) {
				...
				var range = new Range(startRow, startCol, endRow, deleteLastNewLine ? 0 : this.getLine(endRow).length);
	...
	ace.define("ace/background_tokenizer", [
		...
		"ace/lib/oop",
		"ace/lib/event_emitter"
	], function(require, exports$66, module$74) {
		"use strict";
		var oop = require("./lib/oop");
		var EventEmitter = require("./lib/event_emitter").EventEmitter;
		...
		exports$66.BackgroundTokenizer = BackgroundTokenizer;
	});
	ace.define("ace/search_highlight", [
		...
		"ace/lib/lang",
		"ace/range"
	], function(require, exports$67, module$75) {
		"use strict";
		var lang = require("./lib/lang");
		var Range = require("./range").Range;
		...
		exports$67.SearchHighlight = SearchHighlight;
	});
	ace.define("ace/undomanager", [
		...
		"module",
		"ace/range"
	], function(require, exports$68, module$76) {
		"use strict";
		...
		exports$68.UndoManager = UndoManager;
	});
	ace.define("ace/edit_session/fold_line", [
		...
		"module",
		"ace/range"
	], function(require, exports$69, module$77) {
		"use strict";
		var Range = require("../range").Range;
		exports$69.FoldLine = function() {
	...
	ace.define("ace/range_list", [
		...
		"module",
		"ace/range"
	], function(require, exports$70, module$78) {
		"use strict";
		var comparePoints = require("./range").Range.comparePoints;
		...
		exports$70.RangeList = RangeList;
	});
	ace.define("ace/edit_session/fold", [
		...
		"module",
		"ace/range_list"
	], function(require, exports$71, module$79) {
		"use strict";
		var __extends = this && this.__extends || (function() {
			var extendStatics = function(d, b) {
				extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		...
		var Fold = function(_super) {
			...
			Fold.prototype.addSubFold = function(fold) {
				...
				var firstConsumed = 0;
				if (cmp == 0) if (afterStart.range.containsRange(fold)) return afterStart.addSubFold(fold);
	...
	ace.define("ace/edit_session/folding", [
		...
		"ace/token_iterator",
		"ace/mouse/mouse_event"
	], function(require, exports$72, module$80) {
		"use strict";
		var Range = require("../range").Range;
	...
	ace.define("ace/edit_session/bracket_match", [
		...
		"ace/token_iterator",
		"ace/range"
	], function(require, exports$73, module$81) {
		"use strict";
		var TokenIterator = require("../token_iterator").TokenIterator;
		var Range = require("../range").Range;
		function BracketMatch() {
			...
			this.getMatchingBracketRanges = function(pos, isBackwards) {
				...
				return [startRange, new Range(bracketPos.row, bracketPos.column, bracketPos.row, bracketPos.column + 1)];
			};
			this.$brackets = {
				")": "(",
				"(": ")",
							...
							if (tag === currentTag) {
								if (prevToken.value === "<") depth++;
									...
									if (depth < 0) {
										...
										if (token && token.value === ">") var closeTagEnd = new Range(iterator.getCurrentTokenRow(), iterator.getCurrentTokenColumn(), iterator.getCurrentTokenRow(), iterator.getCurrentTokenColumn() + 1);
										else return;
									}
								}
							}
		...
		exports$73.BracketMatch = BracketMatch;
	});
	ace.define("ace/edit_session", [
	...
	], function(require, exports$74, module$82) {
		"use strict";
		var oop = require("./lib/oop");
		var lang = require("./lib/lang");
		...
		exports$74.EditSession = EditSession;
	});
	ace.define("ace/search", [
		...
		"ace/lib/oop",
		"ace/range"
	], function(require, exports$75, module$83) {
		"use strict";
		var lang = require("./lib/lang");
		var oop = require("./lib/oop");
		var Range = require("./range").Range;
		var Search = function() {
			...
			Search.prototype.findAll = function(session) {
				...
				} else for (var matches, i = 0; i < lines.length; i++) if (this.$isMultilineSearch(options)) {
			...
			Search.prototype.parseReplaceString = function(replaceString) {
				...
				for (var i = 0, len = replaceString.length; i < len; i++) {
					...
					if (chCode === CharCode.Backslash) {
						...
						switch (replaceString.charCodeAt(i)) {
		...
		function addWordBoundary(needle, options) {
			...
			function wordBoundary(c, firstChar) {
				...
				if ((supportsLookbehind && options.$supportsUnicodeFlag ? /* @__PURE__ */ new RegExp("[\\p{L}\\p{N}_]", "u") : /* @__PURE__ */ new RegExp("\\w")).test(c) || options.regExp) {
	...
	ace.define("ace/keyboard/hash_handler", [
		...
		"ace/lib/keys",
		"ace/lib/useragent"
	], function(require, exports$76, module$84) {
		"use strict";
		var __extends = this && this.__extends || (function() {
			var extendStatics = function(d, b) {
				extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		...
		exports$76.HashHandler = HashHandler;
		exports$76.MultiHashHandler = MultiHashHandler;
	});
	ace.define("ace/commands/command_manager", [
		...
		"ace/lib/event_emitter"
	], function(require, exports$77, module$85) {
		"use strict";
		var __extends = this && this.__extends || (function() {
			var extendStatics = function(d, b) {
				extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		...
		exports$77.CommandManager = CommandManager;
	});
	ace.define("ace/commands/default_commands", [
		...
		"ace/config",
		"ace/range"
	], function(require, exports$78, module$86) {
		"use strict";
		var lang = require("../lib/lang");
		var config = require("../config");
		var Range = require("../range").Range;
		...
		exports$78.commands = [
			{
				...
				exec: function(editor) {
					config.loadModule("ace/ext/settings_menu", function(module$87) {
						module$87.init(editor);
			...
			},
			{
				...
				exec: function(editor) {
					config.loadModule("ace/ext/error_marker", function(module$88) {
						module$88.showErrorMarker(editor, 1);
					});
				},
			...
			},
			{
				...
				exec: function(editor) {
					config.loadModule("ace/ext/error_marker", function(module$89) {
						module$89.showErrorMarker(editor, -1);
					});
				},
				scrollIntoView: "animate",
				readOnly: true
		...
		for (var i = 1; i < 9; i++) exports$78.commands.push({
			name: "foldToLevel" + i,
	...
	ace.define("ace/keyboard/gutter_handler", [
		...
		"module",
		"ace/lib/keys"
	], function(require, exports$79, module$90) {
		"use strict";
		var keys = require("../lib/keys");
		exports$79.GutterKeyboardHandler = function() {
			...
			GutterKeyboardHandler.prototype.$rowToRowIndex = function(row) {
				for (var i = 0; i < this.lines.getLength(); i++) if (this.lines.get(i).row == row) return i;
				return null;
			};
		...
		exports$79.GutterKeyboardEvent = GutterKeyboardEvent;
	});
	ace.define("ace/editor", [
		...
		"ace/lib/event",
		"ace/tooltip"
	], function(require, exports$80, module$91) {
		"use strict";
		var __values = this && this.__values || function(o) {
			var s = typeof Symbol === "function" && Symbol.iterator, m = s && o[s], i = 0;
			if (m) return m.call(o);
		...
		var Editor = function() {
			...
			Editor.prototype.setKeyboardHandler = function(keyboardHandler, cb) {
				if (keyboardHandler && typeof keyboardHandler === "string" && keyboardHandler != "ace") {
					...
					var _self = this;
					config.loadModule(["keybinding", keyboardHandler], function(module$92) {
						if (_self.$keybindingId == keyboardHandler) _self.keyBinding.setKeyboardHandler(module$92 && module$92.handler);
						cb && cb();
					});
				} else {
			...
			Editor.prototype.prompt = function(message, options, callback) {
				var editor = this;
				config.loadModule("ace/ext/prompt", function(module$93) {
					module$93.prompt(editor, message, options, callback);
				});
			};
	...
	ace.define("ace/layer/lines", [
		...
		"module",
		"ace/lib/dom"
	], function(require, exports$81, module$94) {
		"use strict";
		var dom = require("../lib/dom");
		exports$81.Lines = function() {
	...
	ace.define("ace/layer/gutter", [
		...
		"ace/layer/lines",
		"ace/config"
	], function(require, exports$82, module$95) {
		"use strict";
		var dom = require("../lib/dom");
		var oop = require("../lib/oop");
		var lang = require("../lib/lang");
		...
		var Gutter = function() {
			...
			Gutter.prototype.$updateCursorMarker = function() {
				...
				var top = session.documentToScreenRow(pos) * config.lineHeight - screenPage * lines.canvasHeight;
	...
	ace.define("ace/layer/marker", [
		...
		"ace/range",
		"ace/lib/dom"
	], function(require, exports$83, module$96) {
		"use strict";
		var Range = require("../range").Range;
		var dom = require("../lib/dom");
		var Marker = function() {
			...
			Marker.prototype.update = function(config) {
				...
				for (var key in this.markers) {
					...
					else if (range.isMultiLine()) if (marker.type == "text") this.drawTextMarker(html, range, marker.clazz, config);
		...
		exports$83.Marker = Marker;
	});
	ace.define("ace/layer/text_util", [
		"require",
		"exports",
		"module"
	], function(require, exports$84, module$97) {
		var textTokens = /* @__PURE__ */ new Set([
			"text",
			"rparen",
			"lparen"
		]);
		exports$84.isTextToken = function(tokenType) {
	...
	ace.define("ace/layer/text", [
		...
		"ace/config",
		"ace/layer/text_util"
	], function(require, exports$85, module$98) {
		"use strict";
		var oop = require("../lib/oop");
		var dom = require("../lib/dom");
		var lang = require("../lib/lang");
	...
	ace.define("ace/layer/cursor", [
		...
		"module",
		"ace/lib/dom"
	], function(require, exports$86, module$99) {
		"use strict";
		var dom = require("../lib/dom");
		var Cursor = function() {
			...
			Cursor.prototype.update = function(config) {
				...
				for (var i = 0, n = selections.length; i < n; i++) {
					...
					if (!this.drawCursor) if (!this.isCursorInView(pixelPos, config)) dom.setStyle(style, "display", "none");
					else {
	...
	ace.define("ace/scrollbar", [
		...
		"ace/lib/event",
		"ace/lib/event_emitter"
	], function(require, exports$87, module$100) {
		"use strict";
		var __extends = this && this.__extends || (function() {
			var extendStatics = function(d, b) {
				extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		...
		exports$87.ScrollBar = VScrollBar;
		exports$87.ScrollBarV = VScrollBar;
		exports$87.ScrollBarH = HScrollBar;
		exports$87.VScrollBar = VScrollBar;
		exports$87.HScrollBar = HScrollBar;
	});
	ace.define("ace/scrollbar_custom", [
		...
		"ace/lib/event",
		"ace/lib/event_emitter"
	], function(require, exports$88, module$101) {
		"use strict";
		var __extends = this && this.__extends || (function() {
			var extendStatics = function(d, b) {
				extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d, b) {
		...
		exports$88.ScrollBar = VScrollBar;
		exports$88.ScrollBarV = VScrollBar;
		exports$88.ScrollBarH = HScrollBar;
		exports$88.VScrollBar = VScrollBar;
		exports$88.HScrollBar = HScrollBar;
	});
	ace.define("ace/renderloop", [
		...
		"module",
		"ace/lib/event"
	], function(require, exports$89, module$102) {
		"use strict";
		var event = require("./lib/event");
		exports$89.RenderLoop = function() {
	...
	ace.define("ace/layer/font_metrics", [
		...
		"ace/lib/useragent",
		"ace/lib/event_emitter"
	], function(require, exports$90, module$103) {
		var oop = require("../lib/oop");
		var dom = require("../lib/dom");
		var lang = require("../lib/lang");
		var event = require("../lib/event");
		...
		var FontMetrics = function() {
			...
			FontMetrics.prototype.$initTransformMeasureNodes = function() {
				var t = function(t, l) {
					return ["div", { style: "position: absolute;top:" + t + "px;left:" + l + "px;" }];
				};
		...
		exports$90.FontMetrics = FontMetrics;
	});
	ace.define("ace/css/editor-css", [
		"require",
		"exports",
		"module"
	], function(require, exports$91, module$104) {
	...
	ace.define("ace/layer/decorators", [
		...
		"ace/lib/oop",
		"ace/lib/event_emitter"
	], function(require, exports$92, module$105) {
		"use strict";
		var dom = require("../lib/dom");
		var oop = require("../lib/oop");
		var EventEmitter = require("../lib/event_emitter").EventEmitter;
			...
			Decorator.prototype.$updateDecorators = function(config) {
				...
				if (annotations) {
					...
					for (var i = 0; i < annotations.length; i++) {
						...
						var zoneHeight = ycenter + halfHeight - from;
		...
		exports$92.Decorator = Decorator;
	});
	ace.define("ace/virtual_renderer", [
		...
		"ace/lib/useragent",
		"ace/layer/text_util"
	], function(require, exports$93, module$106) {
		"use strict";
		var oop = require("./lib/oop");
		var dom = require("./lib/dom");
		var lang = require("./lib/lang");
		...
		var VirtualRenderer = function() {
			...
			VirtualRenderer.prototype.getLastFullyVisibleRow = function() {
				var config = this.layerConfig;
				var lastRow = config.lastRow;
				if (this.session.documentToScreenRow(lastRow, 0) * config.lineHeight - this.session.getScrollTop() > config.height - config.lineHeight) return lastRow - 1;
				return lastRow;
			};
			...
			VirtualRenderer.prototype.$renderChanges = function(changes, force) {
				...
				if (changes & this.CHANGE_SCROLL) {
					...
					if (this.$showGutter) if (changes & this.CHANGE_GUTTER || changes & this.CHANGE_LINES) this.$gutterLayer.update(config);
			...
			VirtualRenderer.prototype.setTheme = function(theme, cb) {
				...
				function afterLoad(module$107) {
					if (_self.$themeId != theme) return cb && cb();
					if (!module$107 || !module$107.cssClass) throw new Error("couldn't load module " + theme + " or it didn't call define");
					if (module$107.$id) _self.$themeId = module$107.$id;
					dom.importCssString(module$107.cssText, module$107.cssClass, _self.container);
					if (_self.theme) dom.removeCssClass(_self.container, _self.theme.cssClass);
					var padding = "padding" in module$107 ? module$107.padding : "padding" in (_self.theme || {}) ? 4 : _self.$padding;
					if (_self.$padding && padding != _self.$padding) _self.setPadding(padding);
					if (_self.$gutterLayer) {
						var showGutterCursor = module$107["$showGutterCursorMarker"];
					...
					_self.$theme = module$107.cssClass;
					_self.theme = module$107;
					dom.addCssClass(_self.container, module$107.cssClass);
					dom.setCssClass(_self.container, "ace_dark", module$107.isDark);
					if (_self.$size) {
						_self.$size.width = 0;
						_self.$updateSizeAsync();
					}
					_self._dispatchEvent("themeLoaded", { theme: module$107 });
					cb && cb();
		...
		exports$93.VirtualRenderer = VirtualRenderer;
	});
	ace.define("ace/worker/worker_client", [
		...
		"ace/lib/event_emitter",
		"ace/config"
	], function(require, exports$94, module$108) {
		"use strict";
		var oop = require("../lib/oop");
		var net = require("../lib/net");
		var EventEmitter = require("../lib/event_emitter").EventEmitter;
		...
		(function() {
			...
			this.$sendDeltaQueue = function() {
				...
				if (!q) return;
				this.deltaQueue = null;
				if (q.length > 50 && q.length > this.$doc.getLength() >> 1) this.call("setValue", [this.$doc.getValue()]);
		...
		exports$94.UIWorkerClient = UIWorkerClient;
		exports$94.WorkerClient = WorkerClient;
		exports$94.createWorker = createWorker;
	});
	ace.define("ace/placeholder", [
		...
		"ace/lib/event_emitter",
		"ace/lib/oop"
	], function(require, exports$95, module$109) {
		"use strict";
		var Range = require("./range").Range;
		var EventEmitter = require("./lib/event_emitter").EventEmitter;
		var oop = require("./lib/oop");
		...
		exports$95.PlaceHolder = PlaceHolder;
	});
	ace.define("ace/mouse/multi_select_handler", [
		...
		"ace/lib/event",
		"ace/lib/useragent"
	], function(require, exports$96, module$110) {
		var event = require("../lib/event");
		var useragent = require("../lib/useragent");
		...
		exports$96.onMouseDown = onMouseDown;
	});
	ace.define("ace/commands/multi_select_commands", [
		...
		"module",
		"ace/keyboard/hash_handler"
	], function(require, exports$97, module$111) {
		exports$97.defaultCommands = [
			{
				name: "addCursorAbove",
		...
		exports$97.multiSelectCommands = [{
		...
		exports$97.keyboardHandler = new HashHandler(exports$97.multiSelectCommands);
	});
	ace.define("ace/multi_select", [
		...
		"ace/editor",
		"ace/config"
	], function(require, exports$98, module$112) {
		...
		exports$98.commands = commands.defaultCommands.concat(commands.multiSelectCommands);
		var Search = require("./search").Search;
		...
		exports$98.onSessionChange = function(e) {
		...
		function MultiSelect(editor) {
			...
			editor.$multiselectOnSessionChange = exports$98.onSessionChange.bind(editor);
		...
		exports$98.MultiSelect = MultiSelect;
	...
	ace.define("ace/mode/folding/fold_mode", [
		...
		"module",
		"ace/range"
	], function(require, exports$99, module$113) {
		"use strict";
		var Range = require("../../range").Range;
		var FoldMode = exports$99.FoldMode = function() {};
		(function() {
	...
	ace.define("ace/ext/error_marker", [
		...
		"ace/range",
		"ace/config"
	], function(require, exports$100, module$114) {
		"use strict";
		var dom = require("../lib/dom");
		var Range = require("../range").Range;
		var nls = require("../config").nls;
		...
		exports$100.showErrorMarker = function(editor, dir) {
			var session = editor.session;
			...
			editor.renderer.scrollCursorIntoView(null, .5, { bottom: w.el.offsetHeight });
		};
	...
	ace.define("ace/ace", [
		...
		"ace/config",
		"ace/loader_build"
	], function(require, exports$101, module$115) {
		"use strict";
		require("./loader_build")(exports$101);
		var dom = require("./lib/dom");
		var Range = require("./range").Range;
		var Editor = require("./editor").Editor;
		var EditSession = require("./edit_session").EditSession;
		...
		exports$101.config = require("./config");
		exports$101.edit = function(el, options) {
			if (typeof el == "string") {
				var _id = el;
			...
			var doc = exports$101.createEditSession(value);
		...
		exports$101.createEditSession = function(text, mode) {
			var doc = new EditSession(text, mode);
			doc.setUndoManager(new UndoManager());
			return doc;
		};
		exports$101.Range = Range;
		exports$101.Editor = Editor;
		exports$101.EditSession = EditSession;
		exports$101.UndoManager = UndoManager;
		exports$101.VirtualRenderer = Renderer;
		exports$101.version = exports$101.config.version;
	});
	(function() {
		ace.require(["ace/ace"], function(a) {
			...
			if (typeof module == "object" && typeof exports == "object" && module) module.exports = global.ace;
		});
	})();
}));
//#endregion
//#region node_modules/ace-builds/src-noconflict/ext-language_tools.js
var require_ext_language_tools = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	ace.define("ace/snippets", [
		...
		"ace/clipboard",
		"ace/editor"
	], function(require, exports$11, module$11) {
		"use strict";
		var dom = require("./lib/dom");
		var oop = require("./lib/oop");
		var EventEmitter = require("./lib/event_emitter").EventEmitter;
		...
		var VARIABLES = {
			...
			LINE_COMMENT: function(editor) {
				return (editor.session.$mode || {}).lineCommentStart || "";
			},
		...
		var SnippetManager = function() {
				...
				return str.replace(re, function() {
					...
					for (var i = 0; i < fmtParts.length; i++) {
						...
						if (typeof ch == "object") {
							...
							} else if (ch.changeCase) gChangeCase = ch.changeCase;
						} else if (gChangeCase == "U") fmtParts[i] = ch.toUpperCase();
						else if (gChangeCase == "L") fmtParts[i] = ch.toLowerCase();
					}
				...
				for (var i = 0; i < snippet.length; i++) {
					...
					if (ch.text) {
						...
						if (value && !ch.ifEnd) {
							result.push(value);
							gotoNext(ch);
						} else if (!value && ch.ifEnd) gotoNext(ch.ifEnd);
					} else if (ch.elseEnd) gotoNext(ch.elseEnd);
					else if (ch.tabstopId != null) result.push(ch);
					else if (ch.changeCase != null) result.push(ch);
				}
			...
			SnippetManager.prototype.getDisplayTextForSnippet = function(editor, snippetText) {
				return processSnippetText.call(this, editor, snippetText).text;
			};
			...
			SnippetManager.prototype.getActiveScopes = function(editor) {
				...
				if (snippetMap[scope] && snippetMap[scope].includeScopes) scopes.push.apply(scopes, snippetMap[scope].includeScopes);
				scopes.push("_");
				return scopes;
			};
			...
			SnippetManager.prototype.register = function(snippets, scope) {
				...
				if (Array.isArray(snippets)) snippets.forEach(addSnippet);
				else Object.keys(snippets).forEach(function(key) {
		...
		var processSnippetText = function(editor, snippetText, options) {
			...
			tokens.forEach(function(p, i) {
				...
				}) && !ts.value) ts.value = value;
				else if (value.length && (!ts.value || typeof ts.value !== "string")) ts.value = value.join("");
			});
			...
			function copyValue(val) {
				...
				for (var i = 0; i < val.length; i++) {
					...
					if (typeof p == "object") {
						...
						p = copy[val.lastIndexOf(p, i - 1)] || { tabstopId: p.tabstopId };
					}
					copy[i] = p;
				}
				return copy;
		...
		var TabstopManager = function() {
			...
			TabstopManager.prototype.updateLinkedFields = function() {
				...
				for (var i = 0; i < ts.length; i++) {
					...
					var fmt = exports$11.snippetManager.tmStrFormat(text, original, this.editor);
			...
			TabstopManager.prototype.selectTabstop = function(index) {
				...
				} else this.editor.selection.fromOrientedRange(range);
				this.editor.keyBinding.addKeyboardHandler(this.keyboardHandler);
			...
			TabstopManager.prototype.updateTabstopMarkers = function() {
				...
				if (this.selectedTabstop.index === 0) currentSnippetId--;
		...
		TabstopManager.prototype.keyboardHandler.bindKeys({
			"Tab": function(editor) {
				if (exports$11.snippetManager && exports$11.snippetManager.expandWithTab(editor)) return;
		...
		exports$11.snippetManager = new SnippetManager();
		var Editor = require("./editor").Editor;
		(function() {
			this.insertSnippet = function(content, options) {
				return exports$11.snippetManager.insertSnippet(this, content, options);
			};
			this.expandSnippet = function(options) {
				return exports$11.snippetManager.expandWithTab(this, options);
			};
		}).call(Editor.prototype);
	});
	ace.define("ace/autocomplete/popup", [
		...
		"ace/config",
		"ace/lib/useragent"
	], function(require, exports$12, module$12) {
		"use strict";
		var Renderer = require("../virtual_renderer").VirtualRenderer;
		var Editor = require("../editor").Editor;
		var Range = require("../range").Range;
			...
			function AcePopup(parentNode) {
				...
				popup.renderer.on("afterRender", function() {
					...
					for (var row = t.config.firstRow, l = t.config.lastRow; row <= l; row++) {
						...
						popupRowElement.querySelectorAll(".ace_completion-highlight").forEach(function(span) {
		...
		exports$12.AcePopup = AcePopup;
		exports$12.$singleLineEditor = $singleLineEditor;
		exports$12.getAriaId = getAriaId;
	});
	ace.define("ace/autocomplete/inline_screenreader", [
		"require",
		"exports",
		"module"
	], function(require, exports$13, module$13) {
		"use strict";
		exports$13.AceInlineScreenReader = function() {
				...
				if (!this.popup && this.editor.completer && this.editor.completer.popup) {
					...
					this.popup.renderer.on("afterRender", function() {
						...
						if (selected) {
							...
							for (var lineIndex = 0; lineIndex < this._lines.length; lineIndex++) idString += "ace-inline-screenreader-line-".concat(lineIndex, " ");
	...
	ace.define("ace/autocomplete/util", [
		...
		"exports",
		"module"
	], function(require, exports$15, module$15) {
		"use strict";
		exports$15.parForEach = function(array, fn, callback) {
			var completed = 0;
		...
		exports$15.retrievePrecedingIdentifier = function(text, pos, regex) {
		...
		exports$15.retrieveFollowingIdentifier = function(text, pos, regex) {
			regex = regex || ID_REGEX;
			var buf = [];
		...
		exports$15.getCompletionPrefix = function(editor) {
			var pos = editor.getCursorPosition();
		...
		exports$15.triggerAutocomplete = function(editor, previousChar) {
	...
	ace.define("ace/autocomplete", [
		...
		"ace/lib/event",
		"ace/lib/scroll"
	], function(require, exports$16, module$16) {
		"use strict";
		var HashHandler = require("./keyboard/hash_handler").HashHandler;
		...
		exports$16.Autocomplete = Autocomplete;
		exports$16.CompletionProvider = CompletionProvider;
		exports$16.FilteredList = FilteredList;
	});
	ace.define("ace/marker_group", [
		"require",
		"exports",
		"module"
	], function(require, exports$17, module$17) {
		"use strict";
		...
		exports$17.MarkerGroup = MarkerGroup;
	});
	ace.define("ace/autocomplete/text_completer", [
		...
		"module",
		"ace/range"
	], function(require, exports$18, module$18) {
		var Range = require("../range").Range;
		...
		exports$18.id = "textCompleter";
		exports$18.getCompletions = function(editor, session, pos, prefix, callback) {
	...
	ace.define("ace/ext/language_tools", [
		...
		"ace/editor",
		"ace/config"
	], function(require, exports$19, module$19) {
		"use strict";
		var snippetManager = require("../snippets").snippetManager;
		...
		exports$19.setCompleters = function(val) {
			completers.length = 0;
			if (val) completers.push.apply(completers, val);
		};
		exports$19.addCompleter = function(completer) {
			completers.push(completer);
		};
		exports$19.textCompleter = textCompleter;
		exports$19.keyWordCompleter = keyWordCompleter;
		exports$19.snippetCompleter = snippetCompleter;
		var expandSnippet = {
			name: "expandSnippet",
			exec: function(editor) {
		...
		exports$19.MarkerGroup = MarkerGroup;
	});
	(function() {
...
//#endregion
//#region node_modules/ace-builds/src-noconflict/mode-javascript.js
var require_mode_javascript = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	ace.define("ace/mode/jsdoc_comment_highlight_rules", [
		...
		"ace/lib/oop",
		"ace/mode/text_highlight_rules"
	], function(require, exports$2, module$2) {
		"use strict";
		var oop = require("../lib/oop");
		var TextHighlightRules = require("./text_highlight_rules").TextHighlightRules;
		...
		exports$2.JsDocCommentHighlightRules = JsDocCommentHighlightRules;
	});
	ace.define("ace/mode/javascript_highlight_rules", [
		...
		"ace/mode/text_highlight_rules"
	], function(require, exports$3, module$3) {
		"use strict";
		var oop = require("../lib/oop");
		...
		exports$3.JavaScriptHighlightRules = JavaScriptHighlightRules;
	});
	ace.define("ace/mode/matching_brace_outdent", [
		...
		"module",
		"ace/range"
	], function(require, exports$4, module$4) {
		"use strict";
		var Range = require("../range").Range;
		...
		exports$4.MatchingBraceOutdent = MatchingBraceOutdent;
	});
	ace.define("ace/mode/behaviour/xml", [
		...
		"ace/mode/behaviour",
		"ace/token_iterator"
	], function(require, exports$5, module$5) {
		"use strict";
		var oop = require("../../lib/oop");
		var Behaviour = require("../behaviour").Behaviour;
		var TokenIterator = require("../../token_iterator").TokenIterator;
		...
		var XmlBehaviour = function() {
			this.add("string_dquotes", "insertion", function(state, action, editor, session, text) {
				if (text == "\"" || text == "'") {
					...
					var iterator = new TokenIterator(session, cursor.row, cursor.column);
					var token = iterator.getCurrentToken();
					if (rightChar == quote && (is(token, "attribute-value") || is(token, "string"))) return {
						text: "",
						selection: [1, 1]
					};
					if (!token) token = iterator.stepBackward();
					if (!token) return;
					while (is(token, "tag-whitespace") || is(token, "whitespace")) token = iterator.stepBackward();
		...
		exports$5.XmlBehaviour = XmlBehaviour;
	});
	ace.define("ace/mode/behaviour/javascript", [
	...
	], function(require, exports$6, module$6) {
		"use strict";
		var oop = require("../../lib/oop");
		var TokenIterator = require("../../token_iterator").TokenIterator;
		var CstyleBehaviour = require("../behaviour/cstyle").CstyleBehaviour;
		...
		exports$6.JavaScriptBehaviour = JavaScriptBehaviour;
	});
	ace.define("ace/mode/folding/xml", [
		...
		"ace/range",
		"ace/mode/folding/fold_mode"
	], function(require, exports$7, module$7) {
		"use strict";
		var oop = require("../../lib/oop");
		var Range = require("../../range").Range;
		var BaseFoldMode = require("./fold_mode").FoldMode;
		var FoldMode = exports$7.FoldMode = function(voidElements, optionalEndTags) {
	...
	ace.define("ace/mode/folding/cstyle", [
		...
		"ace/range",
		"ace/mode/folding/fold_mode"
	], function(require, exports$8, module$8) {
		"use strict";
		var oop = require("../../lib/oop");
		var Range = require("../../range").Range;
		var BaseFoldMode = require("./fold_mode").FoldMode;
		var FoldMode = exports$8.FoldMode = function(commentRegex) {
			if (commentRegex) {
	...
	], function(require, exports$9, module$9) {
		"use strict";
		var oop = require("../../lib/oop");
		var XmlFoldMode = require("./xml").FoldMode;
		var CFoldMode = require("./cstyle").FoldMode;
		var FoldMode = exports$9.FoldMode = function(commentRegex) {
			if (commentRegex) {
				this.foldingStartMarker = new RegExp(this.foldingStartMarker.source.replace(/\|[^|]*?$/, "|" + commentRegex.start));
				this.foldingStopMarker = new RegExp(this.foldingStopMarker.source.replace(/\|[^|]*?$/, "|" + commentRegex.end));
			}
	...
	], function(require, exports$10, module$10) {
		"use strict";
		var oop = require("../lib/oop");
...
//#endregion
//#region node_modules/ace-builds/src-noconflict/theme-textmate.js
var require_theme_textmate = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	ace.define("ace/theme/textmate", [
		"require",
		"exports",
		"module",
...
//#endregion
//#region packages/demo/ace-legacy-linters/demo.ts
var import_ace = /* @__PURE__ */ __toESM(require_ace());
require_ext_language_tools();
require_mode_javascript();
require_theme_textmate();
import_ace.config.setModuleUrl("ace/mode/javascript_worker", "./ace-legacy-linters/src-noconflict/worker-javascript.js");
import_ace.require("ace/ext/language_tools");
...
`;
var editor = import_ace.edit("editor", {
