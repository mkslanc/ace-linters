...
manager.registerService("html", {
	...
	module: () => import("./html-service-DC2ny28k.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "HtmlService",
	modes: "html"
});
manager.registerService("css", {
	features: { signatureHelp: false },
	module: () => import("./css-service-vOwCkU4Q.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("json", {
	...
	module: () => import("./json-service-5aSITZC3.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("lua", {
	...
	module: () => import("./lua-service-CAE4qN--.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("yaml", {
	...
	module: () => import("./yaml-service-DOtfzm5V.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("xml", {
	...
	module: () => import("./xml-service-C9_R-GND.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("php", {
	...
	module: () => import("./php-service-m8Rdg2kf.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "PhpService",
	modes: "php"
});
manager.registerServer("pythonls", {
	module: () => import("./language-client-C23ckPK1.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	modes: "python",
	type: "socket",
...
manager.registerService("mysql", {
	module: () => import("./mysql-service-wnPon27l.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
