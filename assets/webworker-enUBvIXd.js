...
manager.registerService("html", {
	...
	module: () => import("./html-service-BSgNuPXh.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "HtmlService",
	modes: "html"
});
manager.registerService("css", {
	features: { signatureHelp: false },
	module: () => import("./css-service-DCKSHkvp.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("json", {
	...
	module: () => import("./json-service-BN8dCVV3.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "JsonService",
	modes: "json"
});
manager.registerService("typescript", {
	module: () => import("./typescript-service-DGt1JCWn.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("lua", {
	...
	module: () => import("./ace-lua-linter-C-CHfurO.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("yaml", {
	...
	module: () => import("./yaml-service-Da2VeP_x.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("xml", {
	...
	module: () => import("./xml-service-DtKfo5Ei.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("php", {
	...
	module: () => import("./php-service-6yAJx2pv.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("javascript", {
	...
	module: () => import("./javascript-service-BqaII-Q7.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("python", {
	...
	module: () => import("./python-service-xJ1yNCBe.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "PythonService",
	modes: "python"
});
manager.registerService("mysql", {
	module: () => import("./mysql-service-BG1z3cWu.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "MySQLService",
	modes: "mysql"
});
manager.registerService("clang", {
	module: () => import("./ace-clang-linter-BLIPMtPb.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "AceClangLinter",
	modes: "c_cpp"
});
manager.registerService("zig", {
	module: () => import("./ace-zig-linter-B4Zq2XeQ.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "AceZigLinter",
	modes: "zig"
});
manager.registerService("dart", {
	module: () => import("./ace-dart-linter-BzufBTjO.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "AceDartLinter",
	modes: "dart"
});
manager.registerService("golang", {
	module: () => import("./ace-go-linter-CP_Bc6PM.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
