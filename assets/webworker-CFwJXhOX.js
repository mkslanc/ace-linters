...
manager.registerService("html", {
	...
	module: () => import("./html-service-DpQr_Na_.js"),
	className: "HtmlService",
	modes: "html"
});
manager.registerService("css", {
	features: { signatureHelp: false },
	module: () => import("./css-service-S-cJPaWf.js"),
...
manager.registerService("json", {
	...
	module: () => import("./json-service-MK_kea3B.js"),
...
manager.registerService("typescript", {
	module: () => import("./typescript-service-utc-fJu8.js"),
...
manager.registerService("lua", {
	...
	module: () => import("./lua-service-1rAaJPpO.js"),
...
manager.registerService("yaml", {
	...
	module: () => import("./yaml-service-D-NBwAES.js"),
...
manager.registerService("xml", {
	...
	module: () => import("./xml-service-DiRYfTCe.js"),
...
manager.registerService("php", {
	...
	module: () => import("./php-service-Buf8LNQy.js"),
...
manager.registerService("javascript", {
	...
	module: () => import("./javascript-service-C8aZFU4s.js"),
...
manager.registerService("python", {
	...
	module: () => import("./python-service-BgVWoAag.js"),
	className: "PythonService",
	modes: "python"
});
manager.registerService("mysql", {
	module: () => import("./mysql-service-Dzxw29ij.js"),
