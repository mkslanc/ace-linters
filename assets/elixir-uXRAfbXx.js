...
var require_elixir_highlight_rules = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop$1 = require_oop();
	var TextHighlightRules = require_text_highlight_rules().TextHighlightRules;
	var ElixirHighlightRules$1 = function() {
		this.$rules = {
			start: [
				{
					token: [
	...
	ElixirHighlightRules$1.metaData = {
	...
	oop$1.inherits(ElixirHighlightRules$1, TextHighlightRules);
	exports.ElixirHighlightRules = ElixirHighlightRules$1;
}));
...
export { require_elixir_highlight_rules as n, require_elixir as t };
