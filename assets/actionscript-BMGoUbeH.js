...
var require_actionscript_highlight_rules = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop$1 = require_oop();
	var TextHighlightRules = require_text_highlight_rules().TextHighlightRules;
	var ActionScriptHighlightRules$1 = function() {
		this.$rules = { start: [
			{
	...
	ActionScriptHighlightRules$1.metaData = {
		fileTypes: ["as"],
		keyEquivalent: "^~A",
		name: "ActionScript",
		scopeName: "source.actionscript.2"
	};
	oop$1.inherits(ActionScriptHighlightRules$1, TextHighlightRules);
	exports.ActionScriptHighlightRules = ActionScriptHighlightRules$1;
}));
var require_actionscript = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop = require_oop();
