...
manager.registerService("html", {
	...
	module: () => import("./html-service-5fmNi5yW.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "HtmlService",
	modes: "html"
});
manager.registerService("css", {
	features: { signatureHelp: false },
	module: () => import("./css-service-CBbjptuX.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("json", {
	...
	module: () => import("./json-service-q6Z85M9d.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "JsonService",
	modes: "json"
});
manager.registerService("typescript", {
	module: () => import("./typescript-service-CmaDYamQ.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("lua", {
	...
	module: () => import("./ace-lua-linter-Cv5w1BNd.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("yaml", {
	...
	module: () => import("./yaml-service-DrZic_hU.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("xml", {
	...
	module: () => import("./xml-service-BjzFN-Ox.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("php", {
	...
	module: () => import("./php-service-I_kg48Vh.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("javascript", {
	...
	module: () => import("./javascript-service-pNTZ2lea.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
...
manager.registerService("python", {
	...
	module: () => import("./python-service-B9KG8DfA.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "PythonService",
	modes: "python"
});
manager.registerService("mysql", {
	module: () => import("./mysql-service-DdiZHjMR.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "MySQLService",
	modes: "mysql"
});
manager.registerService("clang", {
	module: () => import("./ace-clang-linter-Ka9nE1rn.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "AceClangLinter",
	modes: "c_cpp"
});
manager.registerService("zig", {
	module: () => import("./ace-zig-linter-eXIYqRo8.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "AceZigLinter",
	modes: "zig"
});
manager.registerService("dart", {
	module: () => import("./ace-dart-linter-B-lRD_2G.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
	className: "AceDartLinter",
	modes: "dart"
});
manager.registerService("golang", {
	module: () => import("./ace-go-linter-CZWnBAm5.js").then((m) => /* @__PURE__ */ __toESM(m.default)),
