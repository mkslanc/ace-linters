...
var require_prisma_highlight_rules = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop$1 = require_oop();
	var TextHighlightRules = require_text_highlight_rules().TextHighlightRules;
	var PrismaHighlightRules$1 = function() {
		this.$rules = {
			start: [
	...
	PrismaHighlightRules$1.metaData = {
		name: "Prisma",
		scopeName: "source.prisma"
	};
	oop$1.inherits(PrismaHighlightRules$1, TextHighlightRules);
	exports.PrismaHighlightRules = PrismaHighlightRules$1;
}));
