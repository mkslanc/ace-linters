...
//#region node_modules/ace-code/src/mode/lsl_highlight_rules.js
var require_lsl_highlight_rules = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop = require_oop();
...
//#endregion
//#region node_modules/ace-code/src/mode/lsl.js
var require_lsl = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	(function() {
		...
		this.getNextLineIndent = function(state, line, tab) {
			...
			tokenizedLine.state;
			if (tokens.length && tokens[tokens.length - 1].type === "comment.block.lsl") return indent;
			if (state === "start") {
