...
//#region node_modules/ace-code/src/keyboard/vscode.js
var require_vscode = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.handler.addCommands([
		...
		},
		{
			name: "replaceAll",
			exec: function(editor) {
				if (!editor.searchBox) config.loadModule("ace/ext/searchbox", function(e) {
					e.Search(editor, true);
				});
				else if (editor.searchBox.active === true && editor.searchBox.replaceOption.checked === true) editor.searchBox.replaceAll();
			}
		},
		{
			name: "replaceOne",
			exec: function(editor) {
				...
				else if (editor.searchBox.active === true && editor.searchBox.replaceOption.checked === true) editor.searchBox.replace();
			}
		},
		{
			...
			exec: function(editor) {
				...
				else if (editor.searchBox.active === true) editor.searchBox.findAll();
			}
		},
		{
