...
var require_mel_highlight_rules = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop$1 = require_oop();
	var TextHighlightRules = require_text_highlight_rules().TextHighlightRules;
	var MELHighlightRules$1 = function() {
		this.$rules = { start: [
			{
	...
	oop$1.inherits(MELHighlightRules$1, TextHighlightRules);
	exports.MELHighlightRules = MELHighlightRules$1;
}));
var require_mel = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop = require_oop();
