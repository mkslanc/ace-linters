...
var require_red_highlight_rules = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop$1 = require_oop();
	var TextHighlightRules = require_text_highlight_rules().TextHighlightRules;
	var RedHighlightRules$1 = function() {
		this.$rules = {
			"start": [
				{
	...
	oop$1.inherits(RedHighlightRules$1, TextHighlightRules);
	exports.RedHighlightRules = RedHighlightRules$1;
}));
