...
var require_haskell_highlight_rules = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop$1 = require_oop();
	var TextHighlightRules = require_text_highlight_rules().TextHighlightRules;
	var HaskellHighlightRules$1 = function() {
		this.$rules = {
			start: [
				{
					token: [
	...
	HaskellHighlightRules$1.metaData = {
		fileTypes: ["hs"],
		keyEquivalent: "^~H",
		name: "Haskell",
		scopeName: "source.haskell"
	};
	oop$1.inherits(HaskellHighlightRules$1, TextHighlightRules);
	exports.HaskellHighlightRules = HaskellHighlightRules$1;
}));
var require_haskell = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop = require_oop();
