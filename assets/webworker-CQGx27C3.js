...
manager.registerService("html", {
	...
	module: () => import("./html-service-XCr3EPyg.js"),
	className: "HtmlService",
	modes: "html"
});
manager.registerService("css", {
	features: { signatureHelp: false },
	module: () => import("./css-service-DyGdXuX1.js"),
...
manager.registerService("json", {
	...
	module: () => import("./json-service-DhYSWxzW.js"),
...
manager.registerService("typescript", {
	module: () => import("./typescript-service-BpNcjQup.js"),
...
manager.registerService("lua", {
	...
	module: () => import("./ace-lua-linter-4rJNYZJk.js"),
...
manager.registerService("yaml", {
	...
	module: () => import("./yaml-service-4K2DtBYu.js"),
...
manager.registerService("xml", {
	...
	module: () => import("./xml-service-CBvZNI9V.js"),
...
manager.registerService("php", {
	...
	module: () => import("./php-service-CSuUSEA8.js"),
...
manager.registerService("javascript", {
	...
	module: () => import("./javascript-service--w5AoNje.js"),
...
manager.registerService("python", {
	...
	module: () => import("./python-service-CzMxFse9.js"),
	className: "PythonService",
	modes: "python"
});
manager.registerService("mysql", {
	module: () => import("./mysql-service-Cj0915ZV.js"),
	className: "MySQLService",
	modes: "mysql"
});
manager.registerService("clang", {
	module: () => import("./ace-clang-linter-Cntcg8Z6.js"),
	className: "AceClangLinter",
	modes: "c_cpp"
});
manager.registerService("zig", {
	module: () => import("./ace-zig-linter-CREHPgfw.js"),
	className: "AceZigLinter",
	modes: "zig"
});
manager.registerService("dart", {
	module: () => import("./ace-dart-linter-BFH6mYOv.js"),
	className: "AceDartLinter",
	modes: "dart"
});
manager.registerService("golang", {
	module: () => import("./ace-go-linter-4QLx6vdp.js"),
