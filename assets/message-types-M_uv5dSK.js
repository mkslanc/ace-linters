import { i as __toCommonJS, n as __esmMin, r as __export, t as __commonJSMin } from "./chunk-iA-Slpst.js";
...
var require_connection$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function createMessageConnection$1(messageReader, messageWriter, _logger, options) {
		...
		function addMessageToQueue(queue$1, message) {
			if (messages_1$23.Message.isRequest(message)) queue$1.set(createRequestQueueKey(message.id), message);
			else if (messages_1$23.Message.isResponse(message)) queue$1.set(createResponseQueueKey(message.id), message);
			else queue$1.set(createNotificationQueueKey(), message);
		}
...
var require_protocol = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	(function(MessageType$2) {
		MessageType$2.Error = 1;
		MessageType$2.Warning = 2;
		MessageType$2.Info = 3;
		MessageType$2.Log = 4;
		MessageType$2.Debug = 5;
	})(MessageType$1 || (exports.MessageType = MessageType$1 = {}));
		...
		var n$1 = {
			resolve: function() {
				for (var t$2, n$2 = "", i$1 = !1, o$1 = arguments.length - 1; o$1 >= -1 && !i$1; o$1--) {
					var s$1;
					o$1 >= 0 ? s$1 = arguments[o$1] : (void 0 === t$2 && (t$2 = process$1.cwd()), s$1 = t$2), e$1(s$1), 0 !== s$1.length && (n$2 = s$1 + "/" + n$2, i$1 = 47 === s$1.charCodeAt(0));
				}
...
let MessageType = /* @__PURE__ */ function(MessageType$2) {
	MessageType$2[MessageType$2["init"] = 0] = "init";
	MessageType$2[MessageType$2["format"] = 1] = "format";
	MessageType$2[MessageType$2["complete"] = 2] = "complete";
	MessageType$2[MessageType$2["resolveCompletion"] = 3] = "resolveCompletion";
	MessageType$2[MessageType$2["change"] = 4] = "change";
	MessageType$2[MessageType$2["hover"] = 5] = "hover";
	MessageType$2[MessageType$2["validate"] = 6] = "validate";
	MessageType$2[MessageType$2["applyDelta"] = 7] = "applyDelta";
	MessageType$2[MessageType$2["changeMode"] = 8] = "changeMode";
	MessageType$2[MessageType$2["changeOptions"] = 9] = "changeOptions";
	MessageType$2[MessageType$2["closeDocument"] = 10] = "closeDocument";
	MessageType$2[MessageType$2["globalOptions"] = 11] = "globalOptions";
	MessageType$2[MessageType$2["configureFeatures"] = 12] = "configureFeatures";
	MessageType$2[MessageType$2["signatureHelp"] = 13] = "signatureHelp";
	MessageType$2[MessageType$2["documentHighlight"] = 14] = "documentHighlight";
	MessageType$2[MessageType$2["closeConnection"] = 15] = "closeConnection";
	MessageType$2[MessageType$2["capabilitiesChange"] = 16] = "capabilitiesChange";
	MessageType$2[MessageType$2["getSemanticTokens"] = 17] = "getSemanticTokens";
	MessageType$2[MessageType$2["getCodeActions"] = 18] = "getCodeActions";
	MessageType$2[MessageType$2["executeCommand"] = 19] = "executeCommand";
	MessageType$2[MessageType$2["applyEdit"] = 20] = "applyEdit";
	MessageType$2[MessageType$2["appliedEdit"] = 21] = "appliedEdit";
	MessageType$2[MessageType$2["setWorkspace"] = 22] = "setWorkspace";
	MessageType$2[MessageType$2["renameDocument"] = 23] = "renameDocument";
	MessageType$2[MessageType$2["sendRequest"] = 24] = "sendRequest";
	MessageType$2[MessageType$2["showDocument"] = 25] = "showDocument";
	MessageType$2[MessageType$2["sendResponse"] = 26] = "sendResponse";
	MessageType$2[MessageType$2["inlineComplete"] = 27] = "inlineComplete";
	return MessageType$2;
}({});
export { mergeRanges as A, SendResponseMessage as C, checkValueAgainstRegexpArray as D, ValidateMessage as E, require_main as M, convertToUri as O, SendRequestMessage as S, SignatureHelpMessage as T, InitMessage as _, CloseConnectionMessage as a, RenameDocumentMessage as b, ConfigureFeaturesMessage as c, ExecuteCommandMessage as d, FormatMessage as f, HoverMessage as g, GlobalOptionsMessage as h, ChangeOptionsMessage as i, notEmpty as j, mergeObjects as k, DeltasMessage as l, GetSemanticTokensMessage as m, ChangeMessage as n, CloseDocumentMessage as o, GetCodeActionsMessage as p, ChangeModeMessage as r, CompleteMessage as s, AppliedEditMessage as t, DocumentHighlightMessage as u, InlineCompleteMessage as v, SetWorkspaceMessage as w, ResolveCompletionMessage as x, MessageType as y };
