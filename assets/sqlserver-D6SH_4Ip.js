...
//#region node_modules/ace-code/src/mode/sqlserver_highlight_rules.js
var require_sqlserver_highlight_rules = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop = require_oop();
	...
	var SqlServerHighlightRules = function() {
		...
		*/
		...
		for (var i = 0; i < isolationLevels.length; i++) setStatements.push("SET TRANSACTION ISOLATION LEVEL " + isolationLevels[i]);
		this.$rules = {
			start: [
				{
					token: "string.start",
		...
		for (var i = 0; i < setStatements.length; i++) this.$rules.start.unshift({
			token: "set.statement",
...
//#endregion
//#region node_modules/ace-code/src/mode/folding/sqlserver.js
var require_sqlserver$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop = require_oop();
	...
	(function() {
		...
		*/
		this.getBeginEndBlock = function(session, row, column, matchSequence) {
			...
			var endRow = row;
			if (endRow > start.row) return new Range(start.row, start.column, endRow, line.length);
		};
	}).call(FoldMode.prototype);
}));
//#endregion
//#region node_modules/ace-code/src/mode/sqlserver.js
var require_sqlserver = /* @__PURE__ */ __commonJSMin(((exports) => {
	var oop = require_oop();
	var TextMode = require_text().Mode;
	var SqlServerHighlightRules = require_sqlserver_highlight_rules().SqlHighlightRules;
	var SqlServerFoldMode = require_sqlserver$1().FoldMode;
	var Mode = function() {
