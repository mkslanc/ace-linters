...
var require_error_marker = /* @__PURE__ */ __commonJSMin(((exports) => {
	var dom = require_dom();
	...
	exports.showErrorMarker = function(editor, dir) {
		...
		var row = pos.row;
		var oldWidget = session.widgetManager.getWidgetsAtRow(row).filter(function(w$1) {
			return w$1.type == "errorMarker";
		})[0];
...
export { require_error_marker as t };
