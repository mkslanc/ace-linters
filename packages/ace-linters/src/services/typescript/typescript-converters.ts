...
export function fromTsSuggestionDiagnostics(diagnostics: Diagnostic[], doc: TextDocument, filterErrors: FilterDiagnosticsOptions): lsp.Diagnostic[] {
    return convertTsDiagnostics(diagnostics, doc, filterErrors, true);
}

function convertTsDiagnostics(diagnostics: Diagnostic[], doc: TextDocument, filterErrors: FilterDiagnosticsOptions, ignoreTaggedDiagnostics: boolean): lsp.Diagnostic[] {
