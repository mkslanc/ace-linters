    ...
    return {
        ...
        resolve: {
            ...
            alias: useSourceAliases ? [
                ...
                {
                    find: /^ace-zig-linter\/build\/(.*)$/,
                    replacement: resolve(__dirname, 'packages/ace-zig-linter/src/$1.ts')
                },
                {
                    find: /^ace-lua-linter\/build\/(.*)$/,
                    replacement: resolve(__dirname, 'packages/ace-lua-linter/src/$1.ts')
                },
                {
                    find: /^ace-clang-linter\/build\/(.*)$/,
                    replacement: resolve(__dirname, 'packages/ace-clang-linter/src/$1.ts')
                },
                {
                    find: /^ace-dart-linter\/build\/(.*)$/,
                    replacement: resolve(__dirname, 'packages/ace-dart-linter/src/$1.ts')
                },
                {
                    find: /^ace-go-linter\/build\/(.*)$/,
                    replacement: resolve(__dirname, 'packages/ace-go-linter/src/$1.ts')
                },
                {
                    find: /^ace-sql-linter\/build\/(.*)$/,
                    replacement: resolve(__dirname, 'packages/ace-sql-linter/src/$1.ts')
                },
                {
