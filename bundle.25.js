...
!function (e, t) { if (true)
    module.exports = t();
        ...
        function E() { for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++)
            t[r] = arguments[r]; j.apply(void 0, [E, t.length].concat(t)); }
        w.fail = function e(t, r, i, a, s) { var c, u = arguments.length; if (0 === u)
            ...
            throw i; var f = { actual: t, expected: r, operator: void 0 === a ? "fail" : a, stackStartFn: s || e }; void 0 !== i && (f.message = i); var p = new d(f); throw c && (p.message = c, p.generatedMessage = !0), p; }, w.AssertionError = d, w.ok = E, w.equal = function e(t, r, n) { if (arguments.length < 2)
        ...
        function R() { for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++)
            t[r] = arguments[r]; j.apply(void 0, [R, t.length].concat(t)); }
        ...
        var O = function (e) { function t(e) { var r; if (function (e, t) { if (!(e instanceof t))
            ...
            var k = w(u), j = "", E = S[i];
            "notDeepEqual" === i || "notEqual" === i ? (k = "".concat(S[i], "\n\n").concat(k)).length > 1024 && (k = "".concat(k.slice(0, 1021), "...")) : (j = "".concat(w(l)), k.length > 512 && (k = "".concat(k.slice(0, 509), "...")), j.length > 512 && (j = "".concat(j.slice(0, 509), "...")), "deepEqual" === i || "equal" === i ? k = "".concat(E, "\n\n").concat(k, "\n\nshould equal\n\n") : j = " ".concat(i, " ").concat(j)), r = a(this, p(t).call(this, "".concat(k).concat(j)));
        ...
        function F(e, t, r, n) { if (e === t)
            ...
            else if (w(e) && !function (e, t) { return O(e) ? O(t) && c(Number.prototype.valueOf.call(e), Number.prototype.valueOf.call(t)) : k(e) ? k(t) && String.prototype.valueOf.call(e) === String.prototype.valueOf.call(t) : j(e) ? j(t) && Boolean.prototype.valueOf.call(e) === Boolean.prototype.valueOf.call(t) : E(e) ? E(t) && BigInt.prototype.valueOf.call(e) === BigInt.prototype.valueOf.call(t) : T(t) && Symbol.prototype.valueOf.call(e) === Symbol.prototype.valueOf.call(t); }(e, t))
                return !1;
        } return R(e, t, r, n, 0); }
        ...
        e.exports = function (e, t) { if ("string" != typeof e || 0 === e.length)
            ...
            throw new o("`%` may not be present anywhere but at the beginning and end of the intrinsic name"); var r = E(e), n = r.length > 0 ? r[0] : "", i = T("%" + n + "%", t), s = i.name, u = i.value, l = !1, f = i.alias; f && (n = f[0], S(r, x([0, 1], f))); for (var p = 1, h = !0; p < r.length; p += 1) {
        ...
        class c extends a.BaseService {
            ...
            $configureService(e) { let t = this.getOption(e ?? "", "schemas"), r = e ? [] : Object.keys(this.documents); t?.forEach((t => { e ? this.$getJsonSchemaUri(e) == t.uri && (t.fileMatch ??= [], t.fileMatch.push(e)) : t.fileMatch = r.filter((e => this.$getJsonSchemaUri(e) == t.uri)); let n = t.schema ?? this.schemas[t.uri]; n && (this.schemas[t.uri] = n), this.$service.resetSchema(t.uri), t.schema = void 0; })), this.$service.configure({ schemas: t, allowComments: "json5" === this.mode }); }
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }), t.mergeObjects = void 0, t.mergeObjects = function e(t, r) { if (!t)
            return r; if (!r)
            return t; const n = { ...r, ...t }; for (const o of Object.keys(n))
            t[o] && r[o] && (Array.isArray(t[o]) ? n[o] = t[o].concat(r[o]) : Array.isArray(r[o]) ? n[o] = r[o].concat(t[o]) : "object" == typeof t[o] && "object" == typeof r[o] && (n[o] = e(t[o], r[o]))); return n; };
        ...
        function j(e) { return "[object SharedArrayBuffer]" === l(e); }
        function E(e) { return void 0 !== k && (void 0 === j.working && (j.working = j(new k)), j.working ? j(e) : e instanceof k); }
    ...
    } return a + ": " + s; } function m(e) { return Array.isArray(e); } function y(e) { return "boolean" == typeof e; } function v(e) { return null === e; } function b(e) { return "number" == typeof e; } function x(e) { return "string" == typeof e; } function S(e) { return void 0 === e; } function A(e) { return w(e) && "[object RegExp]" === E(e); } function w(e) { return "object" == typeof e && null !== e; } function O(e) { return w(e) && "[object Date]" === E(e); } function k(e) { return w(e) && ("[object Error]" === E(e) || e instanceof Error); } function j(e) { return "function" == typeof e; } function E(e) { return Object.prototype.toString.call(e); } function T(e) { return e < 10 ? "0" + e.toString(10) : e.toString(10); } t.debuglog = function (e) { if (e = e.toUpperCase(), !s[e])
        if (c.test(e)) {
            var r = n.pid;
            s[e] = function () { var n = t.format.apply(t, arguments); o.error("%s %d: %s", e, r, n); };
        }
        else
            s[e] = function () { }; return s[e]; }, t.inspect = l, l.colors = { bold: [1, 22], italic: [3, 23], underline: [4, 24], inverse: [7, 27], white: [37, 39], grey: [90, 39], black: [30, 39], blue: [34, 39], cyan: [36, 39], green: [32, 39], magenta: [35, 39], red: [31, 39], yellow: [33, 39] }, l.styles = { special: "cyan", number: "yellow", boolean: "yellow", undefined: "grey", null: "bold", string: "green", date: "magenta", regexp: "red" }, t.types = r(4895), t.isArray = m, t.isBoolean = y, t.isNull = v, t.isNullOrUndefined = function (e) { return null == e; }, t.isNumber = b, t.isString = x, t.isSymbol = function (e) { return "symbol" == typeof e; }, t.isUndefined = S, t.isRegExp = A, t.types.isRegExp = A, t.isObject = w, t.isDate = O, t.types.isDate = O, t.isError = k, t.types.isNativeError = k, t.isFunction = j, t.isPrimitive = function (e) { return null === e || "boolean" == typeof e || "number" == typeof e || "string" == typeof e || "symbol" == typeof e || void 0 === e; }, t.isBuffer = r(82); var C = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]; function P() { var e = new Date, t = [T(e.getHours()), T(e.getMinutes()), T(e.getSeconds())].join(":"); return [e.getDate(), C[e.getMonth()], t].join(" "); } function I(e, t) { return Object.prototype.hasOwnProperty.call(e, t); } t.log = function () { o.log("%s - %s", P(), t.format.apply(t, arguments)); }, t.inherits = r(1285), t._extend = function (e, t) { if (!t || !w(t))
        ...
        var v, b, x, S, A, w, O, k, j, E, T, C, P, I, M, N, F, _, R, L, D, V, U, $, B, q, W, z, G;
                    ...
                    !function (e, t, r, n) { for (var o = Object.create(null), i = [], a = 0, s = e.properties; a < s.length; a++)
                        ...
                        for (var h = 0, d = Object.keys(t.properties); h < d.length; h++) {
                            ...
                            if (C = o[w])
                                if (X(g))
                                    ...
                                    bt(C, g, j = new dt, n), r.mergePropertyMatch(j);
                        ...
                        for (var y = 0, v = Object.keys(t.patternProperties); y < v.length; y++)
                            for (var b = v[y], x = Y(b), S = 0, A = i.slice(0); S < A.length; S++) {
                                var w = A[S];
                                (null == x ? void 0 : x.test(w)) && (p(w), (C = o[w]) && (X(g = t.patternProperties[b]) ? g ? (r.propertiesMatches++, r.propertiesValueMatches++) : (m = C.parent, r.problems.push({ location: { offset: m.keyNode.offset, length: m.keyNode.length }, message: t.errorMessage || tt("DisallowedExtraPropWarning", "Property {0} is not allowed.", w) })) : (bt(C, g, j = new dt, n), r.mergePropertyMatch(j))));
                            } if ("object" == typeof t.additionalProperties) {
                        for (var O = 0, k = i; O < k.length; O++)
                            if (C = o[w = k[O]]) {
                                var j = new dt;
                                bt(C, t.additionalProperties, j, n), r.mergePropertyMatch(j);
                            }
                    }
                    else if (!1 === t.additionalProperties && i.length > 0)
                        for (var E = 0, T = i; E < T.length; E++) {
                            var C;
                            (C = o[w = T[E]]) && (m = C.parent, r.problems.push({ location: { offset: m.keyNode.offset, length: m.keyNode.length }, message: t.errorMessage || tt("DisallowedExtraPropWarning", "Property {0} is not allowed.", w) }));
                        ...
                        for (var P = 0, I = Object.keys(t.dependencies); P < I.length; P++)
                            if (o[V = I[P]]) {
                                ...
                                if (Array.isArray(M))
                                    ...
                                    (g = ft(M)) && (bt(e, g, j = new dt, n), r.mergePropertyMatch(j));
        ...
        var jt = Qe.loadMessageBundle(), Et = function () { function e(e, t) { this.jsonSchemaService = e, this.promise = t, this.validationEnabled = !0; } return e.prototype.configure = function (e) { e && (this.validationEnabled = !1 !== e.validate, this.commentSeverity = e.allowComments ? void 0 : N.Error); }, e.prototype.doValidation = function (e, t, r, n) { var o = this; if (!this.validationEnabled)
            ...
            var b = jt("InvalidCommentToken", "Comments are not permitted in JSON.");
        ...
        } } var w = /(%[0-9A-Za-z][0-9A-Za-z])+/g; function O(e) { return e.match(w) ? e.replace(w, (function (e) { return A(e); })) : e; } var k, j = r(470), E = function (e, t, r) { if (r || 2 === arguments.length)
            for (var n, o = 0, i = t.length; o < i; o++)
                !n && o in t || (n || (n = Array.prototype.slice.call(t, 0, o)), n[o] = t[o]); return e.concat(n || Array.prototype.slice.call(t)); }, T = j.posix || j, C = "/"; !function (e) { e.joinPath = function (e) { for (var t = [], r = 1; r < arguments.length; r++)
            t[r - 1] = arguments[r]; return e.with({ path: T.join.apply(T, E([e.path], t, !1)) }); }, e.resolvePath = function (e) { for (var t = [], r = 1; r < arguments.length; r++)
            t[r - 1] = arguments[r]; var n = e.path, o = !1; n[0] !== C && (n = C + n, o = !0); var i = T.resolve.apply(T, E([n], t, !1)); return o && i[0] === C && !e.authority && (i = i.substring(1)), e.with({ path: i }); }, e.dirname = function (e) { if (0 === e.path.length || e.path === C)
        ...
        function ir(e, t) { var r = [], n = [], o = [], i = -1, a = f(e.getText(), !1), s = a.scan(); function c(e) { r.push(e), n.push(o.length); } for (; 17 !== s;) {
            ...
            (j = x[b]) < 30 && (v[j] = (v[j] || 0) + 1); var S = 0, A = 0; for (m = 0; m < v.length; m++) {
            var O = v[m];
            if (O) {
                if (O + S > y) {
                    A = m;
            ...
            var j;
            "number" == typeof (j = n[m]) && (j < A || j === A && S++ < y) && k.push(r[m]);
        } return k; }
        ...
        function fr(e) { var t = e.promiseConstructor || Promise, r = new tr(e.schemaRequestService, e.workspaceContext, t); r.setSchemaContributions(Dt); var o = new wt(r, e.contributions, t, e.clientCapabilities), i = new Ot(r, e.contributions, t), a = new Ft(r), s = new Et(r, t); return { configure: function (e) { r.clearExternalSchemas(), e.schemas && e.schemas.forEach((function (e) { r.registerExternalSchema(e.uri, e.fileMatch, e.schema); })), s.configure(e); }, resetSchema: function (e) { return r.onResourceChange(e); }, doValidation: s.doValidation.bind(s), getLanguageStatus: s.getLanguageStatus.bind(s), parseJSONDocument: function (e) { return function (e, t) { var r = [], n = -1, o = e.getText(), i = f(o, !1), a = t && t.collectComments ? [] : void 0; function s() { for (;;) {
                var t = i.scan();
                switch (l(), t) {
                    case 12:
                    case 13:
